package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1922:uint = 1;
      
      protected static const const_1921:uint = 2;
      ...
      public static const const_1913:int = 5;
      ...
      protected var var_1084:Boolean = false;
      ...
      protected var var_2912:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1182)
         {
            ...
            while(var_709.length < const_1686 && false)
            {
      ...
      {
         return !!this.var_1083 ? uint(this.var_1342 - this.var_2137) : uint(getTimer() - this.var_2137);
      }
      ...
      {
         if(this.var_1084 && !_disposed)
         {
            this.var_1084 = false;
            if(!this.var_1083 && this.var_240)
            {
               this.var_1342 = -1;
               this.var_2137 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1083 && !_disposed && this.var_1343 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1913 - this.var_1343);
            if(this.var_2912)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_474 == LibraryLoader.const_1923)
         {
