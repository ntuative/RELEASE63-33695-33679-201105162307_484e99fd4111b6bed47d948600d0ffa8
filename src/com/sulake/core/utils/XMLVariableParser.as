package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1863:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1788:String = "bool";
      ...
      private static const const_1950:String = "HabboRoomUICom_icon_cd_big";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_232 || _loc5_ == const_147)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1863:
               return Number(param1);
            case const_37:
               return param1 == const_656 || int(param1) > 0;
            case const_1788:
               return param1 == const_656 || int(param1) > 0;
            case const_156:
               return uint(param1);
