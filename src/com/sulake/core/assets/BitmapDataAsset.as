   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1546 = BitmapDataAsset(this.var_109).var_1546;
            this.var_1547 = BitmapDataAsset(this.var_109).var_1547;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1546 = _loc4_ == "1" || _loc4_ == "HabboConfigurationCom_default_configuration";
                  break;
               case "flipV":
                  this.var_1547 = _loc4_ == "1" || _loc4_ == "HabboConfigurationCom_default_configuration";
                  break;
            }
            _loc2_++;
         }
