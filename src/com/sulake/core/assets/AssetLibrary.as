package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1202:String = "AssetLibraryReady";
      ...
      private static const const_1066:String = "asset";
      
      private static const const_1067:String = "param";
      ...
      private static var var_1984:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_544:uint = 0;
      
      private static var var_1040:Array = new Array();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1065);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1066);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_448);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1067);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1040.splice(var_1040.indexOf(this),1);
            --var_544;
            this.var_545 = null;
            this.var_1039 = null;
            this.var_171 = null;
      ...
      {
         if(this.var_667 == param1.url && this.var_1042)
         {
            if(!this.var_1041 && param2)
            {
      ...
      {
         return this.var_171[param1] != null || (this.var_666 != null ? this.var_666[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1984.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1065);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1066);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_448).toString() == param1)
               {
                  ...
                  _loc6_ = _loc3_.child(const_1067);
                  if(_loc6_.length())
                  {
