package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1089:LoaderContext;
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1089 = new LoaderContext();
         this.var_1089.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1089);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_336 = 0;
         this.var_43.load(param1,this.var_1089);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_336 < var_2933)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1085 + (this.var_1085.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_336),this.var_1089);
               return true;
            }
         }
         return false;
