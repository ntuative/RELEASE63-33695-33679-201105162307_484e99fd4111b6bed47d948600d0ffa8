package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      override public function dispose() : void
      {
         ...
         this.var_1121 = null;
         this.var_1681 = null;
         for each(_loc2_ in this.var_724)
         {
            while(true)
            {
         ...
         this.var_724 = null;
         for each(_loc3_ in this.var_1391)
         {
         }
         var _loc5_:* = null;
         this.var_1121 = null;
      ...
      {
         var _loc3_:Array = this.var_724[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_724[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_724[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1391)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
