package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1510:String = "_SELECTOR";
      
      private static const const_1511:String = "_CONTENT";
       
      
      protected var var_1091:ITabSelectorWindow;
      
      protected var var_2145:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1091 = findChildByTag(const_1510) as ITabSelectorWindow;
            if(this.var_1091 != null)
            {
               this.var_1091.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2145 = findChildByTag(const_1511) as IWindowContainer;
         }
      ...
      {
         return !!this.var_847 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1091.numSelectables;
      }
