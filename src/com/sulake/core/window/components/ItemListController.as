package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      {
         this._spacing = PropertyDefaults.const_485;
         this.var_866 = PropertyDefaults.const_883;
         this.var_403 = PropertyDefaults.const_959;
         this.var_1082 = PropertyDefaults.const_982;
         this.var_696 = 0;
         this.var_697 = 0;
         this.var_112 = 0;
         this.var_99 = 0;
         ...
         var_175 = var_480 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_432,WindowStyle.const_170,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_391,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_696 * this.maxScrollH,this.var_697 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_696 = param1;
            this._container.x = -this.var_696 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_60);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_520,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_632,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_622,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_391,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_195:
               if(this.var_1339)
               {
                  this.var_1341 = this.var_2135 - _loc3_;
                  this.var_1340 = this.var_2136 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1341 != 0 && this.var_112 != 0)
                     {
                        this.scrollH += this.var_1341 / this.var_112;
                     }
                  }
                  else if(this.var_1340 != 0 && this.var_99 != 0)
                  {
                     this.scrollV += this.var_1340 / this.var_99;
                  }
                  this.var_2135 = _loc3_;
                  this.var_2136 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_204:
               if(this.var_1339)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1341,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1340);
                  }
                  this.var_1339 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_866 && !this.var_567 && this._container)
         {
            this.var_567 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_485)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_421,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1119);
         }
         if(this.var_866 != PropertyDefaults.const_883)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_880,this.var_866,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1742);
         }
         if(this.var_403 != PropertyDefaults.const_959)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_938,this.var_403,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1748);
         }
         if(this.var_1082 != PropertyDefaults.const_982)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_734,this.var_1082,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1720);
         }
         if(this.var_695 != PropertyDefaults.const_1218)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_780,this.var_695,PropertyStruct.const_116,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1785);
         }
         if(this.var_694 != PropertyDefaults.const_1333)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_821,this.var_694,PropertyStruct.const_116,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_880:
                  this.var_866 = _loc2_.value as Boolean;
                  break;
