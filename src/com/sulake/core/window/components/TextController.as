package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1340:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_875:Number;
      ...
      {
         this.var_875 = param1;
         this._field.scrollH = this.var_875 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_875 * this.maxScrollH,this.var_571 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_848,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1321));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1318 ? new PropertyStruct(PropertyDefaults.const_870,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1129) : PropertyDefaults.const_1710);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1152 ? new PropertyStruct(PropertyDefaults.const_1258,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1260) : PropertyDefaults.const_1786);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_857) ? new PropertyStruct(PropertyDefaults.const_374,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1184);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_836 ? new PropertyStruct(PropertyDefaults.const_265,this.var_40.left,PropertyStruct.const_39,true) : PropertyDefaults.const_885);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_818 ? new PropertyStruct(PropertyDefaults.const_248,this.var_40.top,PropertyStruct.const_39,true) : PropertyDefaults.const_909);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_921 ? new PropertyStruct(PropertyDefaults.const_271,this.var_40.right,PropertyStruct.const_39,true) : PropertyDefaults.const_970);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_826 ? new PropertyStruct(PropertyDefaults.const_235,this.var_40.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_858);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1322 ? new PropertyStruct(PropertyDefaults.const_739,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1919);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_116,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_116,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_116,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
