package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_847:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1253,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_847 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_206,event,this,null);
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_347,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_779,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1764);
         _loc1_.push(this.var_1347 != PropertyDefaults.const_1162 ? new PropertyStruct(PropertyDefaults.const_741,this.var_1347,PropertyStruct.const_37,true) : PropertyDefaults.const_1859);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1167 ? new PropertyStruct(PropertyDefaults.const_681,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1746);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1241 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1701);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_779:
                  ...
                  break;
               case PropertyDefaults.const_1148:
