package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_187:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_187 == null || this.var_187.disposed)
         {
            this.var_187 = context.create(name + "::submenu","",WindowType.const_593,var_81,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_187.setGlobalRectangle(_loc1_);
         }
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_187.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1022 = false;
            this.getTitleLabel().text = this.var_662 < this.var_270.length && this.var_662 > -1 ? this.var_270[this.var_662] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_556,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_432,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_662 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_662).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_723)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowEvent.const_583:
               if(param2 == this.var_187)
               {
                  this.closeMenuView();
               }
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_270.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_869,this.var_270,PropertyStruct.const_147,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1688);
         }
         return _loc1_;
      }
