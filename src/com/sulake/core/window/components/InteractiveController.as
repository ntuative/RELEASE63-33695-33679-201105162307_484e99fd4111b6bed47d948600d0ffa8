package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1622 = PropertyDefaults.const_886;
         this.var_1356 = PropertyDefaults.const_406;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_406)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         {
            param2.push(PropertyDefaults.const_1807);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_886)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_856,param1.toolTipDelay,PropertyStruct.const_247,true));
         }
         else
         {
