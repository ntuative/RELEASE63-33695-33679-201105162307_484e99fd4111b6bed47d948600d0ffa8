package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1947:String = "_POINTER_UP";
      
      private static const const_1949:String = "_POINTER_DOWN";
      
      private static const const_1948:String = "_POINTER_LEFT";
      
      private static const const_1946:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_719,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
