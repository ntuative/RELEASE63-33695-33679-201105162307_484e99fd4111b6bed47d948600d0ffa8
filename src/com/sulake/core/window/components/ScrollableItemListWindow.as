package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1248:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_453)
         {
            this.var_453.removeEventListener(WindowEvent.const_242,this.scrollBarEventProc);
            this.var_453.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_453 = null;
         }
         if(this.var_1248)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1248)
         {
            this.var_1248 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_453)
         {
            ...
            if(this.var_453)
            {
               this.var_453.addEventListener(WindowEvent.const_242,this.scrollBarEventProc);
               this.var_453.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            }
         }
         return this.var_453;
      }
