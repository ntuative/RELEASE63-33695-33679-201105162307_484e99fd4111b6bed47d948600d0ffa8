package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1782:uint = 0;
      
      public static const const_804:uint = 1;
      
      public static const const_1253:uint = 2;
      
      public static const const_791:uint = 4;
      
      public static const const_1660:uint = 8;
      
      public static const const_1803:uint = 16;
      
      public static const const_2078:uint = 64;
      
      public static const const_2168:uint = 128;
      
      public static const const_1304:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1253:
               ...
               break;
            case GraphicContext.const_1660:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1803:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_791:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1304:
               break;
            case GraphicContext.const_1782:
               break;
            default:
         ...
         if(this.var_870)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2141,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2141,16777215);
                  }
                  var_337 += bitmap.width * bitmap.height * 4;
               }
