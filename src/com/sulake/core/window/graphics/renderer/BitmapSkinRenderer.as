   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_734.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_734.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_734.blueMultiplier = (param1.color & 255) / 255;
               this.var_734.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_734);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_330 == SkinLayoutEntity.const_336)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_330 == SkinLayoutEntity.const_549)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_330 == SkinLayoutEntity.const_312)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_330 == SkinLayoutEntity.const_464)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_332 == SkinLayoutEntity.const_336)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_549)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_312)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_464)
                  {
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_312 || _loc10_.var_330 == SkinLayoutEntity.const_312)
                  {
                  ...
                  {
                     this.var_249.a = REGION.width;
                     this.var_249.d = REGION.height;
                     this.var_249.tx = REGION.x;
                     this.var_249.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_249,ALPHA);
                  }
                  else
                  {
                     this.var_249.a = 0 / _loc18_.width;
                     this.var_249.d = 0 / _loc18_.height;
                     this.var_249.tx = 0;
                     this.var_249.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_249);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_249,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_330 == SkinLayoutEntity.const_336)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_332 == SkinLayoutEntity.const_336)
               {
