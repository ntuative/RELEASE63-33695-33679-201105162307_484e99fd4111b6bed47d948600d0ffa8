package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_653:uint = 0;
      
      private static const const_1033:uint = 1;
      
      private static const const_1032:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1032) : uint(const_653);
         ...
         if(_loc5_ != const_653)
         {
            this.var_1460 = this.var_959;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1033)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_632)
                  {
                     ...
                     _loc7_.draw(param1,this.var_120,this.var_120.rect,this.var_959,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     this.var_1093.tx = param2.x;
                     this.var_1093.ty = param2.y;
                     this.var_734.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_120,this.var_1093,this.var_734,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_170);
            }
         }
         return _loc2_;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1172:
               ...
               break;
            case WindowRedrawFlag.const_950:
               this.var_959 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_959 != this.var_1460)
               {
                  this.var_632 = true;
                  _loc4_ = true;
               }
