package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "HabboConfigurationCom_default_configuration";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "HabboConfigurationCom_default_configuration";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_330 = SkinLayoutEntity.const_509;
                  break;
               case "move":
                  _loc5_.var_330 = SkinLayoutEntity.const_336;
                  break;
               case "strech":
                  _loc5_.var_330 = SkinLayoutEntity.const_549;
                  break;
               case "tiled":
                  _loc5_.var_330 = SkinLayoutEntity.const_312;
                  break;
               case "center":
                  _loc5_.var_330 = SkinLayoutEntity.const_464;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_332 = SkinLayoutEntity.const_509;
                  break;
               case "move":
                  _loc5_.var_332 = SkinLayoutEntity.const_336;
                  break;
               case "strech":
                  _loc5_.var_332 = SkinLayoutEntity.const_549;
                  break;
               case "tiled":
                  _loc5_.var_332 = SkinLayoutEntity.const_312;
                  break;
               case "center":
                  _loc5_.var_332 = SkinLayoutEntity.const_464;
            }
         }
