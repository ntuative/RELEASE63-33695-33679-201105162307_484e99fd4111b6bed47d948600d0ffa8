package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1071:uint = 8;
      
      private static const const_1563:String = "skin";
      
      private static const const_1562:String = "bitmap";
      
      private static const const_1567:String = "fill";
      
      private static const const_1564:String = "text";
      
      private static const const_1565:String = "label";
      
      private static const const_1566:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_466[const_1563] = BitmapSkinRenderer;
         this.var_466[const_1562] = BitmapDataRenderer;
         this.var_466[const_1567] = FillSkinRenderer;
         this.var_466[const_1564] = TextSkinRenderer;
         this.var_466[const_1565] = LabelRenderer;
         this.var_466[const_1566] = ShapeSkinRenderer;
         this.var_466[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_466[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339.push(WindowState.const_73);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2910 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboConfigurationCom_default_configuration" : false;
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1050[param1] = new Array(const_1071);
         }
         this.var_1050[param1][param2] = param3;
         if(this.var_1049[param1] == null)
         {
            this.var_1049[param1] = new Array(const_1071);
         }
