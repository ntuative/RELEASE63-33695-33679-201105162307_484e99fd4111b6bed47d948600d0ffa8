package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_645:String = "}";
      
      private static const const_1401:String = "/*";
      
      private static const const_1402:String = "*/";
      ...
      public static function method_15(param1:Array, param2:Boolean = false) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(param2)
         {
            _loc5_ = [var_86[const_208],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_208] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboConfigurationCom_default_configuration" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_645);
         if(countSubStrings(param1,const_644) != countSubStrings(param1,const_645))
         {
            throw new Error("Mismatching amount of \"" + const_644 + "\" versus \"" + const_645 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1401) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1402) + 2,_loc5_.length);
            }
