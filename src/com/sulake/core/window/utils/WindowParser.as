package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1224:String = "_EXCLUDE";
      
      public static const const_2026:String = "_INCLUDE";
      
      public static const const_2009:String = "_TEMP";
      
      private static const const_1474:String = "layout";
      
      private static const const_1042:String = "window";
      
      private static const const_1041:String = "variables";
      
      private static const const_1040:String = "filters";
      
      private static const const_448:String = "name";
      
      private static const const_1461:String = "style";
      
      private static const const_657:String = "params";
      
      private static const const_1473:String = "tags";
      ...
      private static const const_1467:String = "caption";
      ...
      private static const const_1468:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1470:String = "treshold";
      
      private static const const_1463:String = "children";
      
      private static const const_1469:String = "width_min";
      ...
      private static const const_656:String = "HabboConfigurationCom_default_configuration";
      ...
      private static const const_1464:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1465:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1088:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1088,this.var_1620);
         this.var_2143 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1465,const_51);
         return param1.replace(const_1464,const_51);
      }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1474)
         {
            _loc8_ = param1.child(const_1041);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1040).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1042);
         ...
         if(param1.localName() == const_1042)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_448,variables,"")));
         style = uint(this.parseAttribute(xml,const_1461,variables,style));
         params = uint(this.parseAttribute(xml,const_657,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1473,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1462,variables,visible.toString()) == const_656;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_657).length() > 0)
         {
            list = xml.child(const_657).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_448,variables,"") as String;
               if(this.var_1088[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_448)) + "\"!");
               }
               params |= this.var_1088[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1467,variables,caption)));
         if(tag != const_51)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1041)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1469,variables,window.limits.minWidth));
         ...
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_656;
         blend = Number(this.parseAttribute(xml,const_1249,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1468,variables,window.clipping.toString()) == const_656;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1470,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1040).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1224) == -1)
                  {
