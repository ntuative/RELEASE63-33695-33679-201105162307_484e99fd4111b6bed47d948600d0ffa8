package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_116:String = "Number";
      ...
      public static const const_232:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2961 = param3 == const_232 || param3 == const_147 || param3 == const_245 || param3 == const_267;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_37:
               return Boolean(this.var_186) == true ? "HabboConfigurationCom_default_configuration" : "HabboRoomUICom_icon_cd_big";
            case const_245:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_232:
               ...
               _loc1_ = "<var key=\"" + this.var_653 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_267:
               ...
               break;
            case const_156:
               _loc1_ = "<var key=\"" + this.var_653 + "\" value=\"" + "0x" + uint(this.var_186).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_653 + "\" value=\"" + this.var_186 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
