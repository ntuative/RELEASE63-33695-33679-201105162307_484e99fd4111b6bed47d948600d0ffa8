package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2135:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1345 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1345);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1531 & const_1156)
         {
            if(_loc3_ == 0)
            {
