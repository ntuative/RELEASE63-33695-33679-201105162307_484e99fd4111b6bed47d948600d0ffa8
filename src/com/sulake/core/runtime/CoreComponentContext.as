package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1523:String = "asset-libraries";
      
      private static const const_1522:String = "library";
      
      private static const const_1519:String = "service-libraries";
      
      private static const const_1520:String = "library";
      
      private static const const_1525:String = "component-libraries";
      ...
      private static const const_1527:String = "error_desc";
       
      
      private var var_389:LibraryLoaderQueue;
      
      private var var_805:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_708:
               ...
               var_407.addChild(new ProfilerViewer(this.var_207));
               break;
            case Core.const_492:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1527,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_805 = loadingEventDelegate;
         if(this.var_389 == null)
         {
         ...
         try
         {
            node = config.child(const_1519)[0];
            if(node != null)
            {
               list = node.child(const_1520);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1525)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1631);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_805)
         {
            this.var_805.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_805)
         {
            ...
            this.var_805.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_805)
                  {
                     this.var_805.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_535 - this.var_389.length,this.var_535,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_207 ? 0 : this.var_1531 & 0;
         if(_loc3_ == Core.const_492)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_104)
         {
            ...
            {
               if(this.var_656[priority] < priority)
               {
                  ++this.var_656[priority];
                  skip = true;
               }
            }
            if(!skip)
