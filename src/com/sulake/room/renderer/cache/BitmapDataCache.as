package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_928 = param1 * 1024 * 1024;
         this.var_1754 = param2 * 1024 * 1024;
         this.var_1424 = param3 * 1024 * 1024;
         if(this.var_1424 < 0)
         {
            this.var_1424 = 0;
         }
      ...
      {
         this.var_928 += this.var_1424;
         if(this.var_928 > this.var_1754)
         {
            this.var_928 = this.var_1754;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_741 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_741 += param2.width * param2.height * 4;
      }
   }
}
