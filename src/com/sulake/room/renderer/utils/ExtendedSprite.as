package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1551:int = 128;
      
      private var var_1550:Boolean = false;
      
      private var var_2963:Point;
      ...
      {
         if(param1 != this.var_1957 || param2 != this.var_1956)
         {
      ...
      {
         if(this.var_1551 > 255 || bitmapData == null)
         {
            return false;
         }
