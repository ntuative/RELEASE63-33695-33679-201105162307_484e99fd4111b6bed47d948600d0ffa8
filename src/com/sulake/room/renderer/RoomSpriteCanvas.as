package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_662:Point = new Point(0,0);
      
      private static const const_367:int = 50;
      
      private static const const_1569:int = 50;
      
      private static const const_1074:Number = 60;
      
      private static const const_1568:Number = 50;
      ...
      private var var_683:RoomObjectCache;
      ...
      private var var_2813:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_683 = new RoomObjectCache(_loc6_);
         this.var_734 = new ColorTransform();
         this.var_678 = new Matrix();
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1005 = true;
            if(this.var_149 != null && !this.var_282.contains(this.var_149))
            {
               this.var_282.addChild(this.var_149);
               this.var_103.mask = this.var_149;
            }
         }
         else if(!param1 && this.var_1005)
         {
            this.var_1005 = false;
            if(this.var_149 != null && this.var_282.contains(this.var_149))
            {
               this.var_282.removeChild(this.var_149);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_282.numChildren > 0)
            {
               this.var_282.removeChildAt(0);
            }
            this.var_282 = null;
         }
         this.var_103 = null;
         ...
         if(this.var_682 != null)
         {
            ...
            {
               this.cleanSprite(this.var_682[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_682 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_149 != null)
         {
            this.var_149.graphics.clear();
         }
         else
         {
            this.var_149 = new Sprite();
            this.var_149.name = "mask";
            if(this.var_1005)
            {
               this.var_282.addChild(this.var_149);
               this.var_103.mask = this.var_149;
         ...
         this.var_149.graphics.beginFill(0);
         this.var_149.graphics.drawRect(0,0,param1,param2);
         this.var_555 = param1;
         this.var_557 = param2;
      }
      ...
      {
         this.var_683.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2018 = !this.var_2018;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1574)
         {
            return;
         }
         ...
         if(this.var_555 != this.var_2809 || this.var_557 != this.var_2811)
         {
            _loc8_ = true;
         }
         if(this.var_103.x != this.var_679 || this.var_103.y != this.var_680)
         {
            this.var_103.x = this.var_679;
            this.var_103.y = this.var_680;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2809 = this.var_555;
         this.var_2811 = this.var_557;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1574 > 0)
         {
            _loc2_ = param1 - this.var_1574;
            if(_loc2_ > const_1074 * 3)
            {
            ...
            {
               ++this.var_837;
               if(this.var_837 == const_367 + 1)
               {
                  this.var_502 = _loc2_;
                  this.var_2017 = this.var_2807;
               }
               else if(this.var_837 > const_367 + 1)
               {
                  _loc3_ = Number(this.var_837 - const_367);
                  this.var_502 = this.var_502 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2017 = this.var_2017 * (_loc3_ - 1) / _loc3_ + Number(this.var_2807) / _loc3_;
                  if(this.var_837 > const_367 + const_1569)
                  {
                     this.var_837 = const_367;
                     if(!this.var_1293 && this.var_502 > const_1074)
                     {
                        this.var_1293 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1293 && this.var_502 < const_1568)
                     {
                        this.var_1293 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_683.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_683.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2018 && this.var_1293);
      ...
      {
         if(param1 < this.var_555 && param1 + param3 >= 0 && (param2 < this.var_557 && param2 + param4 >= 0))
         {
            if(!this.var_2965)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_557)
         {
            param4 -= this.var_557 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2808)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1052)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_682.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1052)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_838 || this.var_838 == 0)
         {
            _loc4_ = this.var_1052 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_678.identity();
            if(flipH)
            {
               this.var_678.scale(-1,1);
               this.var_678.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_678.scale(1,-1);
               this.var_678.translate(0,data.height);
            }
            finalData.draw(data,this.var_678);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_662);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_734.redMultiplier = tR;
            this.var_734.greenMultiplier = tG;
            this.var_734.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_734);
            if(name.length > 0)
            {
               this.var_281.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1294 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_557 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2019,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_681.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_681.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2810 || param2 != this.var_2813)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_681.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_681.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
