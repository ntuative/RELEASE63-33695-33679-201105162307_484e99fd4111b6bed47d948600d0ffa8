package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      {
         if(this.var_1418.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1418.push(param1);
         }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_608.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_608[_loc2_]);
