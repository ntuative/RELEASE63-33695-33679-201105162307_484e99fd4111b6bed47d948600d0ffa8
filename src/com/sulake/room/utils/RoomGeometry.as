package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_840:Number = 64;
      
      public static const const_1288:Number = 32;
      ...
      {
         this.var_413.assign(this.var_93);
         this.var_413.x *= this.var_415;
         this.var_413.y *= this.var_412;
         this.var_413.z *= this.var_411;
         return this.var_413;
      }
      ...
      {
         if(this.var_415 != param1 * this.var_1638)
         {
            this.var_415 = param1 * this.var_1638;
            ++this.var_155;
         }
      }
      ...
      {
         if(this.var_412 != param1 * this.var_1639)
         {
            this.var_412 = param1 * this.var_1639;
            ++this.var_155;
         }
      }
      ...
      {
         if(this.var_411 != param1 * this.var_1637)
         {
            this.var_411 = param1 * this.var_1637;
            ++this.var_155;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_93.x /= this.var_415;
         this.var_93.y /= this.var_412;
         this.var_93.z /= this.var_411;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_414.x;
         var _loc3_:Number = this.var_414.y;
         var _loc4_:Number = this.var_414.z;
         this.var_414.assign(param1);
         this._direction.assign(param1);
         if(this.var_414.x != _loc2_ || this.var_414.y != _loc3_ || this.var_414.z != _loc4_)
         {
            ++this.var_155;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1103.assign(this.var_172);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1104.assign(_loc22_);
         }
         else
         {
            this.var_1104.assign(_loc17_);
         }
         ++this.var_155;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1104);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_412;
            _loc2_.z *= this.var_411;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1104);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_415,this.var_93.y * this.var_412,this.var_93.z * this.var_411);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_172;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_415,param2.y * this.var_412,param2.z * this.var_411);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_415,param3.y * this.var_412,param3.z * this.var_411);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_415,param4.y * this.var_412,param4.z * this.var_411);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1288;
         }
         else
         {
            this.scale = const_840;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_840;
      }
