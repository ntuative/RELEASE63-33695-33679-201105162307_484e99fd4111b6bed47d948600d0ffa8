package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomDoorbell
   {
      ...
      public function show(param1:GuestRoomData, param2:Point = null, param3:Boolean = false) : void
      {
         ...
         if(this.var_2738)
         {
            this.method_1("info","${navigator.doorbell.waiting}");
            this.method_1("cancel","${navigator.doorbell.button.cancel.entering}");
            this.showButton("ring",false);
         }
         else
         {
            this.method_1("info","${navigator.doorbell.info}");
            this.method_1("cancel","${generic.cancel}");
      ...
      public function showNoAnswer() : void
      {
         ...
         this._window.visible = true;
         this._window.activate();
         this.method_1("info","${navigator.doorbell.no.answer}");
         this.showButton("ring",false);
      }
