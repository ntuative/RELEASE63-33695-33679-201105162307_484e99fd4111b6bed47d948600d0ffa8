package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1234:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_652 = new Timer(100);
         this.var_652.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_652)
         {
            this.var_652.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_652.reset();
            this.var_652 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1234.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1906 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1906 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_58 = IItemListWindow(this.var_185.findChildByName("item_list"));
         ...
         this.var_1233 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_185.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1233.goBackToInitialState();
         this.var_1233.input.textBackgroundColor = 4294967295;
         this.var_1234 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1233.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1233.getText();
         var _loc3_:String = "model_" + this.var_1234.name;
