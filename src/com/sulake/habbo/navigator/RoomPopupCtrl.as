package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2224 = new RoomThumbnailRenderer(param1);
         this.var_982 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_182,this.var_121);
         if(this.var_121.ownerName != "" && this.var_121.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_182,!!this.var_121.event ? this.getEventCtg(this.var_121.categoryId) : this.getRoomCtg(this.var_121.categoryId));
         this.refreshRoomDesc(this.var_182,this.var_121);
         this.refreshExtraCont();
         this.refreshInfo(this.var_182,"trading_allowed",this.var_121.allowTrading);
         this.refreshInfo(this.var_182,"doormode_doorbell",this.var_121.doorMode == 1);
         this.refreshInfo(this.var_182,"doormode_password",this.var_121.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_182,this.var_121.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_982.refreshTags(_loc1_,this.var_121.tags);
         ...
         this.var_2224.refreshThumbnail(_loc1_,this.var_121.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_189,Tabs.const_276,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
