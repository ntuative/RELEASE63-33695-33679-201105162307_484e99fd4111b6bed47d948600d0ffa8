package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1838:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1838 == null)
         {
            ...
            this.var_1838 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1838.searchStr.method_1(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_408)
            {
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_189,Tabs.const_276,"-1",MainViewCtrl.const_808);
      }
