package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1973:String = "no_reqs_info";
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_2011 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2011.procedure = this.onDismissAllButtonClick;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_175)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_430 && _loc4_.state != FriendRequest.const_389)
            {
