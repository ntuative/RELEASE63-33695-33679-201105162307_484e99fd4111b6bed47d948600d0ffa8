package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2152:int = "F".charCodeAt(0);
      
      public static const const_2155:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_942 = param1.gender;
         this.var_850 = param1.online;
         this.var_1711 = param1.followingAllowed && param1.online;
         this.var_626 = param1.figure;
         this.var_1834 = param1.motto;
         this.var_1835 = param1.lastAccess;
         this.var_1570 = param1.categoryId;
         this.var_1836 = param1.realName;
