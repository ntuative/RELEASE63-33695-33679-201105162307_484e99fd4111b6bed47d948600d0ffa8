package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_801 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_801.procedure = this.onSearchInput;
         this.var_801.addEventListener(WindowKeyboardEvent.const_206,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_58.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_409,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_801.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_801.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_801.text;
