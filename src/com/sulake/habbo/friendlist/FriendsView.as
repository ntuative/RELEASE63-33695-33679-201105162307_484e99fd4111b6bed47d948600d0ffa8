package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2162:String = "bg";
      ...
      private var var_2435:IContainerButtonWindow;
      ...
      {
         this.var_2437 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2436 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2435 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2160 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2437,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2436,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2435,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2160,this.isEnableRemoveButton(_loc1_));
      }
