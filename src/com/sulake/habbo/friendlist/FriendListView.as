package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1349:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1952:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1952 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1349;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1011 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_269 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1952.prepare(this.var_1011);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1324,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1181,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_881,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_932,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_881,false);
         ...
         this.var_1548 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1548.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1954 == -1 ? 0 : int(this.var_17.height - this.var_1954);
         var _loc4_:int = this.var_1953 == -1 ? 0 : int(this.var_17.width - this.var_1953);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_269.y = Util.getLowestPoint(this.var_17.content);
         this.var_269.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1276,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_881,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1324,false);
         ...
         this.var_1954 = this.var_17.height;
         this.var_1953 = this.var_17.width;
