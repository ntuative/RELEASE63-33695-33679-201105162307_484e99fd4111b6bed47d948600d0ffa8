package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2473:FriendListLookAndFeel;
      
      private var var_429:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1784:OpenedToWebPopup;
      ...
      {
         this.var_2473 = new FriendListLookAndFeel();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_906)
         {
            this.var_906.release(new IIDAvatarRenderManager());
            this.var_906 = null;
         }
         if(this.var_1047)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1784 = new OpenedToWebPopup(this);
         }
         this.var_1784.show(x,y);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_906.createAvatarImage(param1,AvatarScaleType.const_94,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboConfigurationCom_default_configuration";
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_1289,this.getText("friendlist.friends")));
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_433,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_106.findCategory(FriendCategory.const_433);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_429.findTab(FriendListTab.const_101).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_429.findTab(FriendListTab.const_101);
      ...
      {
         var _loc2_:FriendListTab = this.var_429.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_752 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_752.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_752.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
