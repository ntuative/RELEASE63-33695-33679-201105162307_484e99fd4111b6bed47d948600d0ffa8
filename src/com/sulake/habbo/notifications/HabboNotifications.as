package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1445:String = "pixelbalance";
      
      private static const const_1444:String = "badges";
      
      private static const const_1446:String = "selectbadge";
      
      private static const const_1442:String = "inventory";
      
      private static const const_1443:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1447:String = "friendlist";
      
      private static const const_1441:String = "pet_inventory";
      
      private static const const_1440:String = "go_to_room";
      ...
      private var var_365:HabboNotificationViewManager;
      
      private var var_229:HabboAlertDialogManager;
      
      private var var_773:ParkBusDialogManager;
      
      private var var_2532:Boolean;
      
      private var var_964:ClubGiftNotification;
      
      private var var_965:ClubEndingNotification;
      
      private var var_963:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_966);
         }
         var _loc6_:Map = this.var_966["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_966["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_365)
         {
            this.var_365.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1464[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_397);
      }
      ...
      {
         this.var_365 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_966["styles"],this.var_966["view"]);
         ...
         registerUpdateReceiver(this.var_365,1);
         registerUpdateReceiver(this,2);
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_111,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_397.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1135,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1135,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1719,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_872,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_549.createAvatarImage(param2,AvatarScaleType.const_57);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1636,_loc5_);
               }
            }
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1798)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_965 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_963 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_365.isSpaceAvailable() && this.var_1185.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_365.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1444:
               if(this.var_13 != null)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_307);
               }
               break;
            case const_1446:
               break;
      ...
      {
         if(param1 != null && this.var_365 != null)
         {
            this.var_365.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_773 == null)
         {
            this.var_773 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_773 != null)
         {
            this.var_773.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1180,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1180,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_549.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_57);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2532)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_872,null);
            this.var_2532 = true;
      ...
      {
         if(param2.type == WindowEvent.const_177 || param2.type == WindowEvent.const_478)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_964 && this.var_964.visible)
         {
            return;
         }
         this.var_964 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_872,_loc6_);
      }
   }
}
