package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1952:String = "badge_bg_001_png";
      
      private const const_2226:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2622 = this.var_62.getBadgeName(this.var_313);
         this.var_2618 = this.var_62.getBadgeDesc(this.var_313);
         this.var_2621 = this.var_62.getAchievementNameForFacebook(this.var_313,this.var_397.userName,this.var_397.realName,this.var_1190);
         this.var_2619 = this.var_62.getAchievementDescForFacebook(this.var_313,this.var_397.userName,this.var_397.realName,this.var_1190);
         ...
         this.var_62.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1634.toString());
         this.var_62.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1502.toString());
         this.var_62.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1502.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1897;
         var _loc17_:String = this.var_1897 == 0 ? "pixels" : "activitypoints";
         this.var_62.registerParameter(_loc16_,_loc17_,"" + this.var_2623);
         _loc15_.caption = this.var_62.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1952);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2226) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1502 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_313,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_313,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_313,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_62.registerParameter(param1,"badge_name",this.var_2622);
         this.var_62.registerParameter(param1,"badge_desc",this.var_2618);
         this.var_62.registerParameter(param1,"badge_name_fb",this.var_2621);
         this.var_62.registerParameter(param1,"badge_desc_fb",this.var_2619);
         this.var_62.registerParameter(param1,"level",this.var_1190.toString());
         this.var_62.registerParameter(param1,"name",this.var_397.userName);
         return this.var_62.registerParameter(param1,"realname",this.var_397.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_397.events.removeEventListener(BadgeImageReadyEvent.const_111,this.onBadgeImageReady);
            this.var_397 = null;
         }
         if(this._window != null)
         {
      ...
      private function method_1(param1:String, param2:String) : void
      {
         if(this._window == null)
         {
            return;
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_313)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1952);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_313,this._feedTitleFb,this.var_2620,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               ...
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_313,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_313,"client.skip_post"));
               this.dispose();
               return;
         }
      }
