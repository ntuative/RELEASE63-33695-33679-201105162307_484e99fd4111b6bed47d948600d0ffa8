package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_490:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1884 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1884 = 15;
         }
         this.var_1883 = this._window.height;
         this.var_1495 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_532:
               ...
               _loc2_ = Number(this.var_1222) / Number(this.var_993["time_fade_in"]);
               if(this.var_1222 > int(this.var_993["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1045:
               ...
               if(this.var_1494 > int(this.var_993["time_display"]) && !this.var_1885)
               {
                  this.startFadeOut();
               }
               break;
            case const_1044:
               ...
               _loc3_ = 1 - Number(this.var_1223) / Number(this.var_993["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1223 > int(this.var_993["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1884;
         if(this._window.height < this.var_1883)
         {
            this._window.height = this.var_1883;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1721;
