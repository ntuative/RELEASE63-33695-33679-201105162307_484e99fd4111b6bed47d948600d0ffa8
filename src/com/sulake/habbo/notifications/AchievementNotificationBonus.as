package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotificationBonus
   {
      ...
      public function AchievementNotificationBonus(param1:int, param2:String, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager)
      {
         ...
         this._window.center();
         this.method_1("bonus_points","+" + String(param1));
         if(param2 && param2 != "")
         {
            this.var_62.registerParameter("notifications.achievement.bonus_received.name","realname",param2);
            this.method_1("bonus_info",this.var_62.getKey("notifications.achievement.bonus_received.name"));
         }
         var _loc7_:BitmapData = (param3.getAssetByName(this.const_2226) as BitmapDataAsset).content as BitmapData;
