package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_96:IPurchasableOffer;
      ...
      private const const_2210:int = 10;
      ...
      private const const_1965:uint = 4.293848814E9;
      
      private const const_1964:uint = 4.294967295E9;
      ...
      {
         if(this.var_96 == null || this.var_96.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_96.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_96.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_96 is Offer)
            {
               _loc10_ = this.var_96.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_96 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_96.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_96);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_726 = _loc1_.boxTypes;
            this.var_725 = _loc1_.ribbonTypes;
            this.var_1122 = this.var_1685[0];
            this.var_349 = this.var_726[0];
            this.var_350 = this.var_725[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_350 < 0)
         {
            this.var_350 = this.var_725.length - 1;
         }
         if(this.var_350 > this.var_725.length - 1)
         {
            this.var_350 = 0;
         }
         if(this.var_349 < 0)
         {
            this.var_349 = this.var_726.length - 1;
         }
         if(this.var_349 > this.var_726.length - 1)
         {
            this.var_349 = 0;
         }
         var _loc1_:int = this.var_726[this.var_349] * 1000 + this.var_725[this.var_350];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_96.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1122,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1122);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_726[this.var_349]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_725[this.var_350]);
         this._catalog.purchaseProductAsGift(this.var_1394,this.var_96,this.var_1392,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1394,this.var_96.offerId,this.var_1392);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_109:
               ...
               for each(_loc7_ in this.var_238)
               {
                  ...
                  if(_loc5_.length >= this.const_2210)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2262 = _loc3_.text;
               break;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_592 == null)
         {
            this.var_592 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_592.procedure = this.suggestionsEventHandler;
         }
         if(this.var_247 == null || this.var_592 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_592.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1965) : uint(this.const_1964);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1122;
               }
            }
            _loc4_++;
         }
