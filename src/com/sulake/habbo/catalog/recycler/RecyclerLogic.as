package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1011:int = 0;
      ...
      {
         return this.var_597 != const_1011;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1702 != RecyclerStatusMessageEvent.const_1164;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_597 == const_447;
      }
      ...
      {
         this.var_597 = const_1010;
         this.var_114 = new Array(const_212);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1850:
               this.var_597 = const_447;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1164:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1920:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1171:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1828:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_212)
         {
            return false;
         }
         var _loc1_:int = 0;
