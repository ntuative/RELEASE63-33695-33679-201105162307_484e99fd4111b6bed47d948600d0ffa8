package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_665:uint = 1;
      ...
      private var var_1130:IRoomSession;
      ...
      private var var_236:PurchaseConfirmationDialog;
      ...
      private var var_2740:Boolean = true;
      
      private var var_1969:Boolean = false;
      
      private var var_2741:GiftWrappingConfiguration;
      
      private var var_1271:ClubGiftController;
      ...
      private var var_1034:IPurchasableOffer;
      
      private var var_1553:IDragAndDropDoneReceiver;
      
      private var var_67:PlacedObjectPurchaseData;
      
      private const const_1956:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1707);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_236 == null)
            {
               this.var_236 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_236.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_164,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_191.getKey("client.credits.embed.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_823.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_665) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1956;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_283,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1969 = param1.session.isPrivateRoom;
               this.var_1130 = param1.session;
               if(this.var_97 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1271 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_822 && this.var_822 != "")
         {
            this.var_396.openPage(this.var_822);
            this.var_822 = "";
            this.var_1035 = -1;
         }
         else if(this.var_1035 > -1)
         {
            this.var_396.openPageById(this.var_1035,this.var_1970);
            this.var_1035 = -1;
            this.var_1970 = -1;
            this.var_822 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2742 && this._soundManager != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2740 && this._soundManager != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1271.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2741 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_236 != null)
         {
            this.var_236.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_823.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_823.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "HabboConfigurationCom_default_configuration" == this.var_191.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_191.keyExists("catalog.drag_and_drop") || this.var_191.getKey("catalog.drag_and_drop") != "HabboConfigurationCom_default_configuration")
         {
            return false;
         }
         if(!this.var_1130 || !this.var_1130.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_199);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1270 && param1.type == RoomEngineObjectEvent.const_164)
         {
            ...
            _loc3_ = this.var_1034.productContainer.firstProduct;
            _loc4_ = false;
            if(_loc2_ == RoomObjectCategoryEnum.const_26)
            {
               switch(_loc3_.furnitureData.name)
               {
                  ...
                  case "wallpaper":
                  case "landscape":
                     _loc4_ = param1.placedOnFloor || param1.method_12;
                     break;
                  default:
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1034);
            _loc5_ = this.var_1553;
            if(_loc5_ != null)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_211);
         ...
         if(this.var_67 && this.var_67.productClassId == param1.classId)
         {
            if(this.var_67.roomCategory == this._roomEngine.activeRoomCategory && this.var_67.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc6_ = this.var_67.category;
               _loc7_ = this.var_67.wallLocation;
               _loc8_ = this.var_67.x;
               _loc9_ = this.var_67.y;
               _loc10_ = this.var_67.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_341:
                     if(this.var_67.extraParameter != _loc3_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_324:
                     if(this.var_67.extraParameter != _loc2_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_338:
                     if(this.var_67.extraParameter != _loc4_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_665);
            if(_loc1_ != null)
            {
