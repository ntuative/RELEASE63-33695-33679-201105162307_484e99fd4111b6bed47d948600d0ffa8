package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1928:String = "ctlg_";
       
      
      protected var var_2142:XML;
      ...
      private var var_1159:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1928 + param1;
         ...
         this.var_2142 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2142) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1820:
               if(this.var_1159 == null)
               {
                  this.var_1159 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1159);
               }
               break;
