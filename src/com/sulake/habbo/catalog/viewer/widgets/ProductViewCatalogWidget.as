package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1819:Point;
      
      private var var_519:IItemGridWindow;
      
      private var var_1461:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_960 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_1819 = new Point(this.var_89.x,this.var_89.y);
         this.var_519 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1461 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1818 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_960.text = _loc4_;
         this.var_1182.text = _loc5_;
         this.var_960.height = this.var_960.textHeight + 5;
         this.var_1182.y = this.var_960.y + this.var_960.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_554:
                  _loc6_ = this.var_1818.clone();
                  if(this.var_519 != null)
                  {
                     this.var_519.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_519,this.var_1461,this.var_2056);
                     ...
                     case ProductTypeEnum.const_221:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_358,AvatarAction.const_589);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2521)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_89 != null && true)
         {
            ...
            this.var_89.x = this.var_1819.x;
            this.var_89.y = this.var_1819.y;
            if(param3 != null)
            {
