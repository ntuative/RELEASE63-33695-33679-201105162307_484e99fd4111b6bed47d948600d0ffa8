package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1263 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         ...
         this.var_1264 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.method_3(this.var_1031,HabboMusicPrioritiesEnum.const_216,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1263.text = _loc8_;
            }
         }
         else if(this.var_1263 != null)
         {
            this.var_1263.text = "";
         }
         if(this.var_450 != null)
