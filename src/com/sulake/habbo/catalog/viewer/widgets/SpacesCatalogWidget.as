package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1402:String = "default";
      ...
      private var var_1403:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_910 = this.parseElements(_loc2_.floors.pattern);
         this.var_1127 = this.parseElements(_loc2_.walls.pattern);
         this.var_1126 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_910)
                  {
                     _loc11_ = this.var_910[_loc10_];
                     if(this.var_598.indexOf(_loc10_) == -1)
                     {
                        this.var_598.push(_loc10_);
                        this.var_1124.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1127[_loc8_] != null)
                  {
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1402,this.var_1403,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1125[this.var_428];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1402);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1124[this.var_424];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1403);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_598[this.var_424];
         var _loc3_:Array = this.var_910[_loc2_];
         if(_loc3_ != null && this.var_426 >= 0)
         {
            _loc11_ = _loc3_[this.var_426];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1124[this.var_424];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_729[this.var_428];
         var _loc6_:Array = this.var_1127[_loc5_];
         if(_loc6_ != null && this.var_423 >= 0)
         {
            _loc13_ = _loc6_[this.var_423];
            if(_loc13_ != null)
            {
               this.var_1402 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1125[this.var_428];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_728[this.var_427];
         var _loc9_:Array = this.var_1126[_loc8_];
         if(_loc9_ != null && this.var_425 >= 0)
         {
            _loc15_ = _loc9_[this.var_425];
            if(_loc15_ != null)
            {
               this.var_1403 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_106:
               ...
               if(this.var_424 < 0)
               {
                  this.var_424 = this.var_598.length - 1;
               }
               if(this.var_424 >= this.var_598.length)
               {
                  this.var_424 = 0;
               }
               this.var_426 = 0;
               this.var_907 = 0;
               _loc5_ = this.var_598[this.var_424];
               _loc6_ = this.var_910[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_907 = _loc6_.length;
               }
            ...
            case const_224:
               ...
               if(this.var_428 < 0)
               {
                  this.var_428 = this.var_729.length - 1;
               }
               if(this.var_428 == this.var_729.length)
               {
                  this.var_428 = 0;
               }
               this.var_423 = 0;
               this.var_909 = 0;
               _loc7_ = this.var_729[this.var_428];
               _loc8_ = this.var_1127[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_909 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_427 < 0)
               {
                  this.var_427 = this.var_728.length - 1;
               }
               if(this.var_427 >= this.var_728.length)
               {
                  this.var_427 = 0;
               }
               this.var_425 = 0;
               this.var_908 = 0;
               _loc9_ = this.var_728[this.var_427];
               _loc10_ = this.var_1126[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_908 = _loc10_.length;
               }
