package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         this.method_1(_loc3_.findChildByName("gift_name"),_loc5_.name);
         this.method_1(_loc3_.findChildByName("gift_desc"),_loc5_.description);
         if(param2.isVip)
         {
         ...
         this.method_1(_loc3_.findChildByName("months_required"),_loc7_.length > 0 ? this._controller.localization.getKey(_loc7_) : "");
      ...
      private function method_1(param1:IWindow, param2:String) : void
      {
