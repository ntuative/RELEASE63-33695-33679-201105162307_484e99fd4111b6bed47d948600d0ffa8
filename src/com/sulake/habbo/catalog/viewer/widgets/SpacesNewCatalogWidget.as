package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_106[this.var_531]);
      ...
      {
         var _loc2_:int = this.var_633[this.var_531];
         var _loc3_:Offer = this.var_204[this.var_531][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_204[this.var_531][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_633[this.var_531] = (this.var_204[this.var_531] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_633[0];
         var _loc2_:int = this.var_633[1];
         var _loc3_:int = this.var_633[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_82))
            {
               continue;
            }
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_204[this.var_531],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_633[this.var_531];
