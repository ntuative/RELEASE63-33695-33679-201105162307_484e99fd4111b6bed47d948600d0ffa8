package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2178:int = 1;
      
      public const const_2070:int = 2;
      ...
      private var var_236:MarketplaceConfirmationDialog;
      ...
      private var var_2318:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_236)
         {
            this.var_236 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_236.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2317,this.var_2316,this.var_2314,this.var_2311);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2178,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2312 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2070,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2313 || param1.furniTypeId != this.var_2310)
         {
            return;
         }
