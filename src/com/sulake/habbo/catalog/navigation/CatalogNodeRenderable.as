package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1530:Number = 4285716709;
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1808;
            }
         }
      }
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1532) as IItemListWindow;
         if(this.var_58 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1534) as IWindowContainer;
         }
         else
         {
