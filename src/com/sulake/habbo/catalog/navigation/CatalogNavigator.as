package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2979:String = "magic.credits";
      
      private var var_2940:String = "magic.pixels";
      
      private var var_2939:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2940);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2939,true);
      }
