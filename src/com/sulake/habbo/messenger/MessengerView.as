package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_912:ConversationsTabView;
      
      private var var_911:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1405:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_912.refresh();
         this.var_1405.refresh();
         if(this.var_143.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1405.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_912 = new ConversationsTabView(this.var_143,this.var_17);
         this.var_912.refresh();
         this.var_911 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_911.addEventListener(WindowKeyboardEvent.const_206,this.onMessageInput);
         this.var_1405 = new ConversationView(this.var_143,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_789,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1276,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_911.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_911.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_911.text;
         ...
         this.var_911.text = "";
         this.var_143.conversations.addMessageAndUpdateView(new Message(Message.const_730,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_912 == null ? 7 : int(this.var_912.getTabCount());
      }
   }
}
