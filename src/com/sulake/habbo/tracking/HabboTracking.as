package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1064:uint = 11;
      ...
      private var var_1272:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_189:IHabboHelp;
      ...
      private var var_459:FramerateTracker = null;
      
      private var var_274:LatencyTracker = null;
      
      private var var_665:LagWarningLogger = null;
      
      private var var_458:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_459 = new FramerateTracker();
         this.var_274 = new LatencyTracker();
         this.var_665 = new LagWarningLogger();
         this.var_458 = new ToolbarClickTracker(this);
         this.var_1554 = new Array(const_1064);
         var _loc4_:int = 0;
         while(_loc4_ < const_1064)
         {
            this.var_1554[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1758,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1743,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_778,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1199,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1272)
            {
               this.var_1272.release(new IIDHabboWindowManager());
               this.var_1272 = null;
            }
            if(this._adManager)
            {
            ...
            if(this.var_209)
            {
               if(!this.var_209.disposed)
               {
                  ...
                  Component(this.var_209).events.removeEventListener(HabboFriendListTrackingEvent.const_481,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_189)
            {
               ...
               {
                  this.var_189.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_189.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_189.release(new IIDHabboHelp());
               this.var_189 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_309,this.onRoomAction);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_191)
         {
            if(this.var_274 != null)
            {
               this.var_274.configuration = this.var_191;
            }
            if(this.var_273 != null)
            {
               this.var_273.configuration = this.var_191;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1673);
            if(this.var_191)
            {
               if(this.var_665 != null)
               {
                  this.var_665.configure(this.var_191);
               }
               if(this.var_459 != null)
               {
                  this.var_459.configure(this.var_191);
               }
               if(this.var_458 != null)
               {
                  this.var_458.configure(this.var_191);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._communication != null)
         {
            ...
            this._communication.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.method_10));
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_694,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_277,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_691,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_274 != null)
            {
               this.var_274.communication = this._communication;
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_691)
         {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1815);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_694:
               this.trackLoginStep(HabboLoginTrackingStep.const_1654,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_198:
               ...
               break;
            case HabboCommunicationEvent.const_277:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_277);
               if(this.var_274 != null)
               {
                  this.var_274.init();
               }
      ...
      {
         this.var_1272 = IHabboWindowManager(param2);
         if(this.var_1272)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_191)
            {
               if(this.var_191.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1554)
                  {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1268,this.onCoreRunning);
         }
      }
      ...
      private function method_10(param1:HabboAchievementNotificationMessageEvent) : void
      {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_209).events.addEventListener(HabboFriendListTrackingEvent.const_481,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_189 = param2 as IHabboHelp;
         this.var_189.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_189.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2743)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1817);
            this.var_2743 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1199,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_778,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_309,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._adManager.events.addEventListener(AdEvent.const_534,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_309)
         {
            if(this.var_1972 < 1)
            {
               if(!this.var_320)
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_459)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_459.frameRate),_loc2_);
                  ++this.var_1972;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_458)
         {
            this.var_458.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_458)
         {
            this.var_458.track(param1.type);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1973;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1973);
         }
         if(this.var_542 > -1 && _loc2_ - this.var_542 > 15000)
         {
            ++this.var_1971;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1971);
         }
         this.var_542 = _loc2_;
         if(this.var_273 != null)
         {
            this.var_273.update(param1,this.var_542);
         }
         if(this.var_274 != null)
         {
            this.var_274.update(param1,this.var_542);
         }
         if(this.var_459 != null)
         {
            this.var_459.trackUpdate(param1,this,this.var_542);
         }
         if(this.var_665 != null)
         {
            this.var_665.update(this.var_542);
         }
      }
   }
}
