package com.sulake.habbo.tracking
{
   ...
   public class FramerateTracker
   {
      ...
      {
         this.var_2529 = int(param1.getKey("tracking.framerate.reportInterval.seconds","300")) * 1000;
         this.var_2531 = int(param1.getKey("tracking.framerate.maximumEvents","5"));
         this.var_2530 = true;
      }
      ...
      public function trackUpdate(param1:uint, param2:IHabboTracking, param3:int) : void
      {
         ...
         if(this.var_2530 && param3 - this.var_1736 >= this.var_2529)
         {
            this.var_837 = 0;
            if(this.var_1830 < this.var_2531)
            {
