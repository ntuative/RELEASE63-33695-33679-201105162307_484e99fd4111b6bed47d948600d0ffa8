package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1761:IWindow;
      
      private var var_1432:IWindow;
      ...
      private const const_2218:int = 250;
      
      private const const_2216:int = 0;
      
      private const const_2217:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1153 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2434 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2433 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_356 = new Timer(1000,1);
         this.var_356.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_435 = new Timer(10000,1);
         this.var_435.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_356.reset();
            this.var_356.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_356 = null;
         }
         if(this.var_435 != null)
         {
            this.var_435.reset();
            this.var_435.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_435 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:int = this._widget.config.getKey("friendbar.enabled") == "HabboConfigurationCom_default_configuration" ? 55 : 5;
         ...
         this.var_1761 = this._window.findChildByName("send_button_text");
         this.var_1432 = this._window.findChildByName("block_text");
         this.var_1761.caption = this.const_2217;
         this.var_25.setParamFlag(HabboWindowParam.const_44,true);
         this.var_25.addEventListener(WindowMouseEvent.const_42,this.windowMouseEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_206,this.windowKeyEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_347,this.keyUpHandler);
         ...
         this.var_1431 = true;
         this.var_613 = "";
         this._window.addEventListener(WindowEvent.const_866,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_558,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2218 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2216);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1153 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_613 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_613.length + 1)
            {
