package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1451:int = 9;
      
      private static const const_1034:int = 10;
      
      private static const const_654:int = 25;
      ...
      private static const const_1035:int = (const_655 + const_450) * const_114 + const_114;
      
      private static const const_451:int = 9;
      
      private static const const_1454:int = 200;
      
      private static const const_1453:int = 40;
      ...
      private var var_230:int = 171.0;
      
      private var var_974:int = 18;
      
      private var var_2956:int = 100;
      ...
      public function RoomChatWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:int, param7:Component, param8:IHabboQuestEngine)
      {
         ...
         this.var_42 = param2.createWindow("chat_container","",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_47,new Rectangle(0,0,200,this.var_230 + RoomChatHistoryPulldown.const_84),null,0) as IWindowContainer;
         this.var_42.background = true;
         this.var_42.color = 33554431;
         this.var_42.tags.push("room_widget_chat");
         this.var_366 = param2.createWindow("chat_contentlist","",HabboWindowType.const_1208,HabboWindowStyle.const_47,0 | 0,new Rectangle(0,0,200,this.var_230),null,0) as IItemListWindow;
         this.var_42.addChild(this.var_366);
         this.var_122 = param2.createWindow("chat_active_content","",HabboWindowType.const_80,HabboWindowStyle.const_47,HabboWindowParam.const_64,new Rectangle(0,0,200,this.var_230),null,0) as IWindowContainer;
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1188 && this.var_1188 > 0)
         {
            this.var_1188 = -1;
            this.animationStart();
         }
         if(this.var_900)
         {
            _loc2_ = param1 / const_1449 * const_1450;
            if(_loc2_ + this.var_973 > this.var_974)
            {
               _loc2_ = this.var_974 - this.var_973;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_973 >= this.var_974)
            {
               this.var_974 = const_114;
               this.var_973 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1188 = getTimer() + const_1036;
            }
         }
         if(this.var_29 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_969,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_620,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_850,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_969,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_620,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_850,this.onRoomViewUpdate);
      ...
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         if(this.var_972 != 1)
         {
            _loc2_.senderX /= this.var_972;
         }
         _loc2_.senderX -= this.var_776.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1839 == 0)
            {
               this.var_1839 = param1.scale;
            }
            else
            {
               this.var_972 = param1.scale / this.var_1839;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_776.x += param1.positionDelta.x / this.var_972;
            this.var_776.y += param1.positionDelta.y / this.var_972;
         }
         if(param1.rect != null)
         {
            if(this.var_29 == null)
            ...
            this.var_42.height = this.var_230 + this.var_29.pulldownBarHeight;
            this.var_366.width = this.var_42.width - this.var_29.scrollbarWidth;
            this.var_366.height = this.var_230;
            this.var_366.x = this.var_42.x;
            this.var_366.y = this.var_42.y;
            this.var_122.width = this.var_42.width - this.var_29.scrollbarWidth;
            this.var_122.height = this.var_230;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_69.length > const_1452 || this.historyViewerActive() && this.var_69.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_974 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_69[0]);
            }
            else
            {
               this.var_974 = const_114;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_777,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_777;
               if(_loc1_.aboveLevels > const_655 + const_450 + 2)
               {
                  _loc1_.aboveLevels = const_655 + const_450 + 2;
               }
               this.var_777 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_450 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1455)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         this.var_2540 = !!this._questEngine.isTrackerVisible() ? int(const_1454) : 0;
         var _loc2_:Number = (param1.senderX + this.var_776.x) * this.var_972;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_42.width / 2 - const_1034 + this.var_2956;
         var _loc6_:Number = this.var_42.width / 2 + const_1034 - this.var_29.scrollbarWidth - this.var_2540;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_777);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_114 - const_451;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_230 + this.var_42.y;
      }
      ...
      {
         return "chat_" + this.var_2542.toString() + "_item_" + (this.var_2541++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_606,param1,param3);
      ...
      {
         var _loc2_:int = this.var_42.context.getDesktopWindow().height - 0 - const_1453;
         param1 = Math.min(param1,_loc2_);
         this.var_230 = param1 - this.var_42.y;
         this.var_42.height = this.var_230 + RoomChatHistoryPulldown.const_84;
         if(this.var_29 != null)
         {
            this.var_29.containerResized(this.var_42.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_230 = const_1035 + const_451;
         this.var_42.height = this.var_230 + this.var_29.pulldownBarHeight;
         this.var_366.width = this.var_42.width - this.var_29.scrollbarWidth;
         this.var_366.height = this.var_230;
         this.var_122.width = this.var_42.width - this.var_29.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_122.height = this.getTotalContentHeight() + const_451;
         }
         else
         {
            this.var_122.height = this.var_230;
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_1035)
         {
            if(_loc1_ <= this.var_230 + this.var_42.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1840 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1840 = false;
         }
