package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2967:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2967 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_439:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_62,this.var_139,this.var_2834++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_425:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_62,this.var_139,this);
               break;
            case RoomWidgetEnum.const_480:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_62,this.var_139,this._catalog);
               break;
            case RoomWidgetEnum.const_566:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_62,events,this.var_139);
               break;
            ...
            case RoomWidgetEnum.const_472:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_62,this.var_139,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_603:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_62,this.var_139);
               break;
            case RoomWidgetEnum.const_763:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_62,this.var_139);
               break;
            case RoomWidgetEnum.const_121:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_62,this.var_139);
               break;
            ...
            case RoomWidgetEnum.const_126:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_139,this.var_62,this);
               break;
            ...
            case RoomWidgetEnum.const_535:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_62,this.var_139,this._catalog);
               break;
