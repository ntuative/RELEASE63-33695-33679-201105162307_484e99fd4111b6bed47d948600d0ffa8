package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1231:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1232 = 0;
         this.var_1231 = param2.rectangle.clone();
         this.var_1231.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1231.width)
         {
            return false;
         }
         if(this.var_1232 + param1.height > this.var_1231.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1231.width)
         {
            this._offsetX = 0;
            this.var_1232 += param1.height + this.const_2227;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1232);
         this._offsetX += param1.width + this.const_2228;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1508 != null && this.var_1508.indexOf(param1) != -1)
         {
