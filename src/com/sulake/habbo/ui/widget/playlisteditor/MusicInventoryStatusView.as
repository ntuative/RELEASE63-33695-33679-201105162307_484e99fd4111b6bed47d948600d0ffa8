package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_698:String = "MISV_BUY_MORE";
      
      public static const const_879:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_416.getValues())
         {
            _loc1_.destroy();
         }
         this.var_416 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_416[param1] as IWindowContainer,0);
         this.var_45 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1636.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_879,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_698,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_416.add(const_879,_loc1_);
            this.var_1635 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1636 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_416.add(const_698,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_493));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_416[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
