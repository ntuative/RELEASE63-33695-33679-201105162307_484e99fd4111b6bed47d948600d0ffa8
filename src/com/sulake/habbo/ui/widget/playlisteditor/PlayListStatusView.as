package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_868:String = "PLSV_ADD_SONGS";
      
      public static const const_1149:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_45 != const_628)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_416[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_416[const_868];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_416.add(const_628,_loc1_);
