package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      {
         this.hideOffer();
         this.var_254 = new PollOfferDialog(this._id,param1,this.var_1179);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_254 = new PollContentDialog(this._id,param1,param3,this.var_1179);
      }
      ...
      {
         this.var_1179.windowManager.alert("${poll_thanks_title}",this.var_2033,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
