package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2151 = "spamwall_postit_container";
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_413 = param1.location;
         var_1358 = param1.objectType;
         _text = "";
         var_334 = "FFFF33";
         _controller = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_218 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_680,var_218,this.var_413,_text,var_334);
