package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1603:Array = new Array("trophy_bg_gold","trophy_bg_silver","trophy_bg_bronze");
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.const_968,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.const_968,this.onObjectUpdate);
      }
      ...
      private function showInterface() : void
      {
         ...
         _loc8_ = assets.getAssetByName(const_1603[this._color]) as BitmapDataAsset;
