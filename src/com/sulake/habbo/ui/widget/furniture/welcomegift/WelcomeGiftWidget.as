package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_643:String = "welcome_gift_email_unverified";
      
      private const const_1020:String = "welcome_gift_email_verified";
      
      private const const_1392:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_643);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_643:
               ...
               this._view.findChildByName("edit_text").visible = this.var_933;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_933);
               break;
            ...
            case this.const_1392:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_933);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1435;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1392);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_965,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1155 ? this.const_1020 : this.const_643);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_545,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_545,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_545:
               this.var_1435 = param1.email;
               this.var_1155 = param1.isVerified;
               this.var_933 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1435 = this.var_1434;
            this.setViewState(this.const_643);
         }
         else
         {
            if(param1.result == this.const_2219)
            {
               this.var_933 = false;
            }
