package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1970:int = 1;
      
      private const const_1972:int = 2;
      
      private const const_1969:int = 3;
      
      private const const_1966:int = 4;
      
      private const const_2239:int = 0;
      
      private const const_2246:int = 1;
      
      private const const_2242:int = 2;
      
      private const const_2240:int = 3;
      
      private const const_2245:int = 4;
      
      private const const_2244:int = 5;
      
      private const const_1971:String = "deco_img";
      
      private const const_1968:String = "dialog_bg";
      
      private const const_2241:String = "%campaign%_dialog_bg.png";
      
      private const const_365:String = "%campaign%_gift_package.png";
      
      private const const_2238:String = "%campaign%_gift_content.png";
      
      private const const_2243:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1563 = this.var_139.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1563 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1562.length)
         {
            _loc2_ = this.var_1562.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_139 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_494,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_494,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_494:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_940:
               ...
               this._shareId = null;
               this.var_1564 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1561 != _loc2_ || _loc3_ != this.var_193))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1561)
            {
               ...
               case this.const_1970:
                  ...
                  else if(this.var_404 == this.const_2246)
                  {
                  ...
                  else if(this.var_404 == this.const_2242)
                  {
                  ...
                  else if(this.var_404 == this.const_2240)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_404 == this.const_2245)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_193,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_404 == this.const_2244)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2241.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc5_,this.const_1968);
            _loc2_ = _loc2_.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc2_,this.const_1971);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_702);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1564 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1564 == 1 ? "null" : InventoryCategory.const_133);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_847,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1562.push(new ImageDownloader(this,_assets,this.var_193,this.var_1563,param1,param2));
            return;
         }
