package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_949:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_948 = param1.volume;
         if(this.var_949 != null)
         {
            this.var_949.setValue(this.var_948);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_949 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_984));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_948 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_944);
         }
         else
         {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_828);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_810);
         }
