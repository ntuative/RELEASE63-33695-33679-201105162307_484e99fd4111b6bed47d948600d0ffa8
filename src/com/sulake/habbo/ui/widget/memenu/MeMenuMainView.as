package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_174["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_174["dance_icon"] = ["dance_white","dance_color"];
         this.var_174["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_174["effects_icon"] = ["effects_white","effects_color"];
         this.var_174["badges_icon"] = ["badges_white","badges_color"];
         this.var_174["wave_icon"] = ["wave_white","wave_color"];
         this.var_174["hc_icon"] = ["_white","_color"];
         this.var_174["settings_icon"] = ["settings_white","settings_color"];
         this.var_174["credits_icon"] = ["credits_white","credits_color"];
         this.var_174["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_174[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_174[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_174[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_174)
         {
            _loc6_ = this.var_174[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1139);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1212));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1273));
               this._widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1330));
               this._widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration";
               if(false && _loc4_)
               {
