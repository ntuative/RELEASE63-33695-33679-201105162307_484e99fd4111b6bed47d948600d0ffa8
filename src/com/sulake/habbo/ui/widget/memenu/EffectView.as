package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2207:int = 1000;
      ...
      {
         super();
         this.var_211 = new Timer(this.const_2207);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_178.isActive)
         {
            ...
            this.var_898.width = _loc2_ * this.var_327;
         }
         else
         {
            this.var_898.width = 0;
            this.var_211.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_718 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_718 == null)
            {
               return;
            }
         ...
         if(!this.var_178.isActive)
         {
            this.var_718.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_718.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_718.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_897 = this._window.findChildByName("effect_hilite");
            this.var_897.visible = false;
         }
         this.setTimeLeft();
         this.var_898 = this._window.findChildByName("loader_bar");
         if(this.var_898 != null)
         {
            this.var_327 = this.var_898.width;
            this.var_211.start();
            this.onUpdate();
         }
