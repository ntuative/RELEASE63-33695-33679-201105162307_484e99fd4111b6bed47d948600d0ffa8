package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1518:int = 25;
      ...
      protected var var_2150:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2148 = new FixedSizeStack(const_1518);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_2300 = param4;
         param1.var_2149 = param6;
         param1.updateWindow();
      }
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1354)
         {
            ...
            if(this.var_1621 == RoomObjectTypeEnum.const_150 || this.var_1621 == RoomObjectTypeEnum.const_602)
            {
            ...
            if(_loc6_ < this.var_2150 - const_1053)
            {
               _loc6_ = this.var_2150 - const_1053;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2150 = _loc6_;
