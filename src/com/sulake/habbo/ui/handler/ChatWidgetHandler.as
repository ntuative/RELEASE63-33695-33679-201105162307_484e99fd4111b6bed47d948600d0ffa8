package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1898:Map = null;
      
      private var var_1227:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1228:Number = 0.0;
      
      private var var_795:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_314 != null)
         {
            ...
            {
               _loc2_ = this.var_314.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_975,RoomWidgetChatSelectAvatarMessage.const_699];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_975:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1126))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1126))
                              {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_314.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_218)
                                    {
                                       this.var_314.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1228 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1228);
            }
            if(this.var_795 == null)
            {
               ...
               this.var_526.y = 0;
               this.var_526.z = 0;
               this.var_795 = _loc4_.getScreenPoint(this.var_526);
               this.var_1228 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_526.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_795.x || _loc8_.y != this.var_795.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_795,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_314)
         {
            _loc2_ = this.var_314.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1898.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1898.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_314)
            {
               this.var_314.add(_loc3_,param2);
            }
         }
      }
   }
