package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_986,RoomWidgetViralFurniMessage.const_702,RoomWidgetViralFurniMessage.const_182];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_986:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_494);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_702:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_562,RoomSessionViralFurniStatusEvent.const_504];
      }
