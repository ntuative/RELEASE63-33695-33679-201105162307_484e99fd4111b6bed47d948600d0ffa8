package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_220.events.addEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_220.events.addEventListener(SongInfoReceivedEvent.const_93,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_179,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_179,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_220 != null)
         {
            this.var_220.events.removeEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_220.events.removeEventListener(SongInfoReceivedEvent.const_93,this.onSongInfoReceivedEvent);
            this.var_220 = null;
         }
         this.var_1090 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_606);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_900);
         _loc1_.push(RoomWidgetFurniActionMessage.const_916);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_812);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_911);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1795);
         _loc1_.push(RoomWidgetPetCommandMessage.const_592);
         _loc1_.push(RoomWidgetPetCommandMessage.const_979);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_604)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_403 || param1.type == RoomWidgetUserActionMessage.const_614 || param1.type == RoomWidgetUserActionMessage.const_524)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_606:
            ...
            case RoomWidgetFurniActionMessage.const_824:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_900:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_916:
            ...
            case RoomWidgetUserActionMessage.const_403:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_812:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_911:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_261);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_295) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_295);
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_261);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1316);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1315);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  {
                     _loc30_ = this.var_220.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_384.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_220.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_150)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_602)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_579);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_129)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_163)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_777);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_807;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_896;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1725);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_777);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_220 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_220.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_393,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_220 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_371,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
