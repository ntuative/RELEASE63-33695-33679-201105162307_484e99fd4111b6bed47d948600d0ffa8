   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_751,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_924,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_805,this.onHelpTutorialEvent);
         ...
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_751,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_924,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_805,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1492)
            {
               ...
               this.var_1875 = _loc1_;
               this.var_1876 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1875;
               _loc2_ = this.var_1876;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_453)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_453,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_453 - const_1043)
                  {
                     _loc8_.offset(0,_loc2_.height - const_453 + const_1043);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_915);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_442);
         _loc1_.push(RoomWidgetStopEffectMessage.const_798);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1894);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1313);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_385);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1901);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1183);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_823);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_893);
         _loc1_.push(RoomWidgetMeMenuMessage.const_865);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_984);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1899);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_828);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_810);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_966);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_893:
               ...
               break;
            case RoomWidgetWaveMessage.const_915:
            ...
            case RoomWidgetSelectEffectMessage.const_817:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_442:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1330)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_799:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1306:
                        this._catalog.openCatalogPage(CatalogPageName.const_1619,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1273:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_307);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1658:
            ...
            case RoomWidgetStopEffectMessage.const_798:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1313:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_823:
               if(this._container != null)
               {
            ...
            case RoomWidgetAvatarEditorMessage.const_385:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_984:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_828:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_414,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_810:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_414,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_966:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_474));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_422:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_731));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_861));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_128:
               ...
               break;
            case HabboHelpTutorialEvent.const_805:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_594));
         }
      }
