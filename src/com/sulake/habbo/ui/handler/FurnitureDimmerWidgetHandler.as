package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_887,RoomWidgetDimmerSavePresetMessage.const_767,RoomWidgetDimmerChangeStateMessage.const_971,RoomWidgetDimmerPreviewMessage.const_718];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_887:
            ...
            case RoomWidgetDimmerSavePresetMessage.const_767:
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_971:
               if(this.validateRights())
               {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_462:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_710);
               _loc3_.selectedPresetId = _loc2_.selectedPresetId;
               _loc6_ = 0;
               while(_loc6_ < _loc2_.method_2)
               {
