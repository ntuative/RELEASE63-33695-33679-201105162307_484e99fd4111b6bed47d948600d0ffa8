package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_962);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_962:
            ...
            case RoomWidgetRoomQueueMessage.const_676:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1168);
               break;
      ...
      {
         return [RoomSessionQueueEvent.const_471];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_471:
               ...
               {
                  case RoomSessionQueueEvent.const_1168:
                     _loc3_ = "null";
                     break;
