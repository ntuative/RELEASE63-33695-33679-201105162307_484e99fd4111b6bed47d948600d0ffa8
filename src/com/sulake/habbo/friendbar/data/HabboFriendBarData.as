package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_667:String = "Navigation";
      
      private static const const_666:String = "Friend Bar";
      
      private static const const_1542:String = "go.friendbar";
      
      private static const const_1540:String = "chat_btn_click";
      
      private static const const_1541:String = "find_friends_btn_click";
      
      private static const const_1068:String = "Toolbar";
      
      private static const const_1070:String = "open";
      
      private static const const_1069:String = "close";
      
      private static const const_1538:String = "FRIENDLIST";
      
      private static const const_1539:String = "MESSENGER";
       
      
      private var var_90:IHabboCommunicationManager;
      
      private var var_323:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_323)
            {
               this.var_323.release(new IIDHabboFriendList());
               this.var_323 = null;
            }
            if(this.var_464)
            {
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_90)
         {
            ...
            this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_666,const_1542));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_464)
         {
            ...
            if(this.var_90)
            {
               this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_666,const_1540));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_90)
         {
            ...
            this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_667,const_666,const_1541));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_323)
         {
            if(!this.var_323.disposed)
            {
               if(!this.var_323.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_323.openFriendRequests();
                  }
                  else
                  {
                     this.var_323.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_323.mainWindow;
               ...
               if(this.var_90)
               {
                  this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1068,const_1538,!!this.var_323.isOpen() ? const_1070 : const_1069));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_464)
         {
            if(!this.var_464.disposed)
            {
               ...
               if(this.var_90)
               {
                  this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1068,const_1539,!!this.var_464.isOpen() ? const_1070 : const_1069));
               }
            }
         }
      }
      ...
      {
         this.var_323 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_147.splice(this.var_147.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_147 = !!const_297 ? this.sortByNameAndOnlineStatus(this.var_147) : this.sortByName(this.var_147);
         }
