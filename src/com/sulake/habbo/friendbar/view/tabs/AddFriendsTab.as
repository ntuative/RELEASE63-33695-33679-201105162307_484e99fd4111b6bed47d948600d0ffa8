package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1978:String = "title";
      
      private static const BUTTON:String = "button";
      
      private static const const_1592:String = "addFriendsTabXML";
      
      private static const const_1591:String = "add_friends_icon_png";
      
      private static var var_1068:int = -1;
      
      private static const const_72:uint = 6907230;
      
      private static const const_1026:uint = 9209986;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_449.pop() : var_1335.buildFromXML(var_863.getAssetByName(const_1592).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_648));
         ...
         if(var_1068 < 0)
         {
            var_1068 = _loc1_.height;
         }
         _loc1_.height = name_1;
         var _loc3_:IBitmapWrapperWindow = _loc1_.findChildByName(const_1084) as IBitmapWrapperWindow;
         _loc3_.disposesBitmap = false;
         _loc3_.bitmap = var_863.getAssetByName(const_1591).content as BitmapData;
