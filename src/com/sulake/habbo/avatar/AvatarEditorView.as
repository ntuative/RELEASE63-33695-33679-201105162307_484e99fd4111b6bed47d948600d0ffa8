package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2099:int = 6710886;
      ...
      private var var_386:ITabSelectorWindow;
      ...
      private var var_2690:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1247 = [];
         this.var_1524 = [AvatarEditorFigureCategory.const_709,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_244,AvatarEditorFigureCategory.const_942,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1247.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1247.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2690 = this.canChangeOutfit();
            this.var_452.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_386 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_386.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_386.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1247.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_386.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_386.numSelectables)
               {
                  this.var_386.getSelectableAt(_loc6_).x = this.var_386.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_386.setSelected(this.var_386.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1930 == AvatarEditorSideCategory.const_108 || this.var_2691))
         {
      ...
      {
         if(this.var_1930 == AvatarEditorSideCategory.const_108)
         {
            this.var_2691 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_843:
               break;
            case AvatarEditorSideCategory.const_536:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_536);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_372 = param1;
         this.var_386.setSelected(this.var_386.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2689 = new Date().valueOf();
                  this.var_2690 = false;
                  this.var_452.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2689 > 5000;
      }
   }
}
