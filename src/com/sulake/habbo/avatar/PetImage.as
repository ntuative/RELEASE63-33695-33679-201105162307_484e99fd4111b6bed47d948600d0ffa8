package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_1090:Boolean;
      ...
      private var var_626:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_626 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_626.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1383 = this.var_1237;
         ...
         this.var_899 = new ActiveActionData(AvatarAction.const_400);
         this.var_899.definition = this._structure.getActionDefinition(const_1364);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_626,param1);
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1383);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_642,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_286.definition.geometryType,this.var_91);
         this.var_47.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_642);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_626,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1383 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_642);
                  _loc20_ = this.var_91;
                  _loc21_ = 1;
                  switch(this.var_91)
                  {
         ...
         if(this.var_569 != null)
         {
            if(this.var_569.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc23_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_569.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_642);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_626,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_94)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_642);
                  _loc21_ = this.var_91;
                  _loc22_ = 1;
                  switch(this.var_91)
                  {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_569 = null;
         this.var_1672 = 0;
         this.var_286 = this.var_899;
         this.var_286.definition = this.var_899.definition;
      ...
      {
         this.var_1384 = true;
         if(this.var_1484 == this.var_523)
         {
            return;
         }
         this.var_1484 = this.var_523;
         this.var_1382 = this._structure.sortActions(this.var_333);
         ...
         {
            this.var_715 = this._structure.getCanvasOffsets(this.var_1382,this._scale,this.var_91);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1382)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_390)
               {
                  this.var_900 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1237 = _loc4_.id;
                     this.var_1673 = _loc4_.breed;
                     break;
                  }
               }
            }
