package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2214 = parseInt(param1.@precedence);
         this.var_2215 = String(param1.@activepartset);
         this.var_2213 = String(param1.@assetpartdefinition);
         this.var_2220 = String(param1.@lay);
         this.var_719 = String(param1.@geometrytype);
         this.var_2217 = Boolean(parseInt(param1.@main));
         this.var_2218 = Boolean(parseInt(param1.@var_865));
         this.var_2216 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboConfigurationCom_default_configuration"));
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1659[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2219;
         }
         return _loc2_;
      }
