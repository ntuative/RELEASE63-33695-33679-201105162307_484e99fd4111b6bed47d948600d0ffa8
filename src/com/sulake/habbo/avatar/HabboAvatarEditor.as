package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1547:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_1565:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_942 = FigureData.const_77;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            _loc2_.loadAvatarData(const_1547,FigureData.const_77);
            _loc3_.loadAvatarData(const_1548,FigureData.FEMALE);
            this.var_106 = new Map();
            this.var_550 = new Map();
            this.var_106.add(AvatarEditorFigureCategory.const_709,new BodyModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_244,new TorsoModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_942,new LegsModel(this));
            ...
            this.var_550.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
            this.var_550.add(AvatarEditorSideCategory.const_536,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_275 == null)
            {
               this.var_275 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_709);
         }
      ...
      {
         this.var_1045 = this.var_549.getFigureData(AvatarType.const_132);
      ...
      {
         return this.var_669[this.var_942];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1565 != null)
         {
            ...
            this.var_1565.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_550.getValue(AvatarEditorSideCategory.const_108);
      }
