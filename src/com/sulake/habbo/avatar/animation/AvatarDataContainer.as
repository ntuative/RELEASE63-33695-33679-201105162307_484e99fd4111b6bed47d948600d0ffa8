package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_734 = new ColorTransform(this.var_1644,this.var_1643,this.var_1645,this._alphaMultiplier);
         this.var_1303 = this.generatePaletteMapForGrayscale(this.var_2836,this.var_2837);
      }
