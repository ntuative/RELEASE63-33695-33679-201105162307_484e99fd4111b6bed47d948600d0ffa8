package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_626:AvatarFigureContainer;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_261.length == 1 && this.var_91 == this.var_1910)
         {
            return this.var_91 + this.var_523 + this.var_642 % 4;
         }
         if(this.var_261.length == 2)
         {
            for each(_loc1_ in this.var_261)
            {
               ...
               {
                  return this.var_91 + this.var_523 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_642 % 11;
                  return this.var_91 + "_" + this.var_1910 + this.var_523 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2587 || param2 != this.var_2588 || param1 != this.var_2589)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_286.definition.geometryType,this.var_91);
         this.var_47.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_642);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_642);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_333.push(new ActiveActionData(param1,param2,this.var_642));
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_523 = "";
         this.var_261 = this._structure.sortActions(this.var_333);
         if(this.var_261 == null)
         {
         ...
         {
            this.var_715 = this._structure.getCanvasOffsets(this.var_261,this._scale,this.var_91);
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_261)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_354 || _loc1_.actionType == AvatarAction.const_236 || _loc1_.actionType == AvatarAction.const_390)
               {
                  this.var_900 = true;
               }
            }
