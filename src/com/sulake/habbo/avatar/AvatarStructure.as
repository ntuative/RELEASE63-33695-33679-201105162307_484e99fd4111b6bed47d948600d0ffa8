package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_455:AvatarRenderManager;
      ...
      private var var_1408:PartOffsetData;
      ...
      {
         this.var_1408.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_918 = new AvatarActionManager(param1,this.var_500,param2);
         this.var_899 = this.var_918.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_500 == AvatarType.const_132)
            {
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_600[param1] = new Dictionary();
         }
         if(this.var_600[param1][param2])
         {
            return this.var_600[param1][param2];
         }
         this.var_600[param1][param2] = this.var_353.getMandatorySetTypeIds(param1,param2);
         return this.var_600[param1][param2];
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            if(_loc7_ != null)
            {
               _loc2_ = _loc7_.method_8(0,param1.overridingAction);
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc24_ in _loc9_.method_8(0,param3.overridingAction))
               {
                  if(_loc24_ == param1)
                  {
      ...
      {
         return this.var_1408.getOffset(param1,param2,param3,param4,param5,param6);
      }
