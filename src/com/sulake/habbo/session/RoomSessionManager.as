package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1974)
         {
            this.gotoRoom(this.var_2747,this.var_2749,this.var_1975);
            this.var_1974 = false;
            this.var_1975 = "";
         }
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               ...
               case RoomSessionHandler.const_1214:
                  break;
               case RoomSessionHandler.const_816:
