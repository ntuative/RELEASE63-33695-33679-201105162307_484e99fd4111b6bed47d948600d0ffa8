package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1037:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1456:String = "sendAccessTokenToServer";
      
      private static const const_1457:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1456,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1457,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1037);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1037);
         }
      }
