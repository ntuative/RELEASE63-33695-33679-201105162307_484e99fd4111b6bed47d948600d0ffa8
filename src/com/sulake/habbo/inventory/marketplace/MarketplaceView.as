package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         this.var_2768 = this._localization.getKey(_loc5_);
         this.method_1("furni_name","${" + _loc5_ + "}");
         this.method_1("furni_desc","${" + _loc6_ + "}");
         this._view.procedure = this.clickHandler;
         this._view.center();
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2768);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1983.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_68.makeOffer(this.var_1983);
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_1983 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboConfigurationCom_default_configuration" == this._config.getKey("client.credits.embed.enabled"))
         {
