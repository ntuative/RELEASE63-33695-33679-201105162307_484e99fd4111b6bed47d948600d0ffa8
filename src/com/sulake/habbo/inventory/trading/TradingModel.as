package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1805:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_57.updateItemList(this.var_833);
         this.var_57.updateItemList(this.var_1569);
      ...
      public function close() : void
      {
         if(this.var_711)
         {
            if(this._state != const_192 && this._state != const_288)
            {
      ...
      {
         this.var_57.setMinimized(param1 != InventoryCategory.const_74);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_832 + " OTHER: " + this.var_1287);
         ...
         {
            case const_192:
               if(param1 == const_193 || param1 == const_288)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_57.alertPopup(TradingView.const_1132);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1287 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_57.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_57.alertPopup(TradingView.const_1215);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_278.length < const_1805)
         {
