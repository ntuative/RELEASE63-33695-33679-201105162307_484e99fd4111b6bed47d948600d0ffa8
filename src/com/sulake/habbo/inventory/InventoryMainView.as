package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2732:IWindowContainer;
      ...
      private const const_1956:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_819);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_394 != null && this.var_394 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_394 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_819);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_394);
         }
         ...
         _loc2_.container.removeChild(this.var_1964);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_394 == InventoryCategory.const_133)
            {
               this.toggleCategoryView(InventoryCategory.const_133);
            }
            else if(this.var_394 == InventoryCategory.const_74)
            {
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(!this.var_1032)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc3_.x = _loc4_.width - _loc3_.width - const_996;
               _loc3_.y = const_996;
            }
            this.var_1032 = _loc3_;
         }
         if(_loc1_ > 0)
         {
            this.var_1032.visible = true;
            this.var_1032.findChildByName("count").caption = _loc1_.toString();
         }
         else
         {
