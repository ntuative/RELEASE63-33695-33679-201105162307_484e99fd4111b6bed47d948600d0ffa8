package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_42:
               this.var_1453.setSelectedGridItem(this);
               this.var_1454 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1454 = false;
                  this.var_1453.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1452)
         {
            return;
         }
         this.var_1452.color = !!this.var_2507 ? uint(const_1417) : uint(const_1418);
         this.var_2506.visible = param1;
      }
