package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1061:int = 42;
      
      private static const const_1060:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this._soundManager.events.addEventListener(SongInfoReceivedEvent.const_93,this.onSongInfoReceivedEvent);
         this.var_392 = new Map();
         this.var_392.add(FurniModelCategory.const_40,new FurniGridView(this.var_68,FurniModelCategory.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_392.add(FurniModelCategory.const_45,new FurniGridView(this.var_68,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModelCategory.const_40);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._soundManager)
            {
               ...
               {
                  this._soundManager.events.removeEventListener(SongInfoReceivedEvent.const_93,this.onSongInfoReceivedEvent);
               }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_392.getValue(this.var_457);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_457);
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_40,FurniModelCategory.const_45];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_392.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_392.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_392.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:String, param2:GroupItem, param3:int) : void
      {
         if(param2 == null)
         {
            return;
         ...
         _loc4_.moveItemTo(param2.window,param3);
      }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_68.getUnseenItemCount(UnseenItemCategoryEnum.const_416) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_68.getUnseenItemCount(UnseenItemCategoryEnum.const_401) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_457);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_199);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1211)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1060)
         {
            _loc3_ = const_1060;
         }
         else if(_loc3_ < const_1061)
         {
            _loc3_ = const_1061;
         }
         else
