package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1490:int = 1000;
      ...
      private var var_1903:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_529 = [];
         this.var_530 = [];
         this.var_650 = new Timer(const_1491,1);
         ...
         this.var_2630 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_164,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_40)
            {
               ...
               {
                  this.var_1903 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1903;
            }
            else
            {
         ...
         if(this.getSelectedItemIndex(const_40) == -1)
         {
            this.toggleItemSelection(const_40,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_800 == null)
         {
            this.var_800 = this._windowManager.buildFromXML(this.var_2630) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_800.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_800.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_74 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_273:
                  this._controller.toggleInventoryPage(InventoryCategory.const_133);
            }
         }
      }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_651.add(const_40,new Array());
         this.var_651.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_40;
            _loc5_ = this.var_529.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_530.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            if(_loc7_)
            {
               ...
               if(_loc5_)
               {
                  _loc11_ = _loc8_.indexOf(_loc7_);
                  _loc8_.splice(_loc11_,1);
                  _loc8_.unshift(_loc7_);
                  this._view.moveItemTo(_loc6_,_loc7_,0);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2631 + const_1490;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_341 || _loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_338)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_917)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_529.indexOf(_loc2_) == -1)
            {
               this.var_529.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_530.indexOf(_loc2_) == -1)
            {
               this.var_530.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_416:
               return this.var_529.length;
            case UnseenItemCategoryEnum.const_401:
               return this.var_530.length;
            default:
               return this.var_529.length + this.var_530.length;
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         {
            case const_45:
               if(this.var_530 && this.var_530.length > 0)
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_401));
                  this.var_530 = [];
                  _loc2_ = this.getCategoryContent(const_45);
               }
               break;
            case const_40:
               if(this.var_529 && this.var_529.length > 0)
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_416));
                  this.var_529 = [];
