package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1418:int = 13421772;
      
      private static const const_1417:int = 10275685;
      ...
      protected var var_2932:BitmapData;
      
      private var var_2020:Boolean;
      
      private const const_1976:Number = 1;
      
      private const const_1975:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2506 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2931 == FurniModelCategory.const_40)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1379));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2158);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_917)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1975;
               _loc1_.blend = this.const_1975;
            }
            else
            {
               this._window.blend = this.const_1976;
               _loc1_.blend = this.const_1976;
            }
         }
         this.var_1452.color = !!this.var_2020 ? uint(const_1417) : uint(const_1418);
         this.var_2506.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2157 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2932;
               _loc5_.visible = true;
            }
            else
            {
