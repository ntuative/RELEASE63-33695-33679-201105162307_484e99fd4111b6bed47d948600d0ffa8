package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2211:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_502,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_51.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_345));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_706));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_51.getValue(InventorySubCategory.const_1176));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_133));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_502,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function initInventory() : void
      {
         ...
         this.var_51.add(InventoryCategory.const_74,_loc2_);
         ...
         this.var_51.add(InventoryCategory.const_706,_loc4_);
         ...
         this.var_51.add(InventorySubCategory.const_345,_loc6_);
         ...
         this.var_51.add(InventorySubCategory.const_1176,_loc7_);
         ...
         this.var_51.add(InventoryCategory.const_133,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_915.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_915.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_915.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_915.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2211);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_751));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2346)
         {
            this.var_2346 = _loc1_;
      ...
      {
         return this._config.getKey("standaloneAchievementList.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration";
      }
   }
}
