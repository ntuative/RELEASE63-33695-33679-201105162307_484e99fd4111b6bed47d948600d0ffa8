package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1478:uint = 1;
      ...
      private var var_988:IWindowRenderer;
      ...
      private var var_1872:ProfilerOutput;
      
      private var var_1490:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_988 = new WindowRenderer(this._skinContainer);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_988,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_275 = this._windowContextArray[const_1478];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1872)
            {
               this.var_1872 = new ProfilerOutput(context,this,this.var_988);
            }
            this.var_1872.profiler = _loc3_;
            this.var_1490 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1490);
            this.var_1491 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         var _loc3_:Dictionary = this.var_263[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_263[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_275.getDesktopWindow().numChildren - 1);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1645,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1632,param2.name + ": " + param2.toString());
            }
         }
      }
