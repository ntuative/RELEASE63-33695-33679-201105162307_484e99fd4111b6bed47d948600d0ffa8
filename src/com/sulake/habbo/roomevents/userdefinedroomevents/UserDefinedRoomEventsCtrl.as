package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1572:int = 2;
      ...
      private var var_2013:TriggerConfs;
      
      private var var_2014:ActionTypes;
      
      private var var_2015:ConditionTypes;
      
      private var var_280:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_836:RoomObjectHightLighter;
      
      private var var_189:UserDefinedRoomEventsHelp;
      
      private var var_1291:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2013 = new TriggerConfs();
         this.var_2014 = new ActionTypes();
         this.var_2015 = new ConditionTypes();
         this.var_280 = new Dictionary();
         super();
         this.var_83 = param1;
         this.var_836 = new RoomObjectHightLighter(param1);
         this.var_189 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_280[param1];
            this.var_836.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_280[param1] = param2;
            this.var_836.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1291 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_83.assets,0,20,1);
         this.var_1291.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1291.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_836.hideAll(this.var_280);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1291.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_189.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1572) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1572 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2013);
         this.refreshConfigureElement(this.var_2014);
         this.refreshConfigureElement(this.var_2015);
      ...
      private function method_1(param1:IWindowContainer, param2:String, param3:String) : void
      {
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         this.method_1(_loc3_,"conf_name_txt",this.getElementName(this.var_37.stuffTypeId));
         this.method_1(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_37.stuffTypeId));
      ...
      private function refreshWarning(param1:String, param2:String) : void
      {
         ...
         this.method_1(_loc3_,"caption_txt",param1);
         this.method_1(_loc3_,"desc_txt",param2);
