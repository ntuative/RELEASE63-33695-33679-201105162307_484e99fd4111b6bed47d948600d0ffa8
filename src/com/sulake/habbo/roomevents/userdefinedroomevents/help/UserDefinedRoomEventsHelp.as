package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1171 = this.var_1804.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1171)
         {
            this.var_1171.procedure = this.onButtonClick;
         }
         this.var_1170 = this.var_1804.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1170)
         {
      ...
      {
         if(this.var_253 >= this.var_62.length - 1)
         {
      ...
      {
         ++this.var_253;
         this.var_253 = Math.min(this.var_253,this.var_62.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_253;
         this.var_253 = Math.max(this.var_253,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_62[this.var_253][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_62[this.var_253][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_62[this.var_253][1]).value;
