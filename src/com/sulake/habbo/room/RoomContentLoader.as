package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1979:int = 0;
      ...
      private static const const_671:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1092:String = "selection_arrow";
      ...
      private var var_1605:IEventDispatcher = null;
      ...
      private var var_1074:Map = null;
      
      private var var_214:PublicRoomData = null;
      
      private var var_1604:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2890 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1062)
         {
            return;
         }
         this.var_1605 = param1;
         this.var_2891 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2889 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_472.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_472.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_853.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            _loc8_ = this.var_692.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_692.remove(_loc7_);
               this.var_692.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2892)
         {
            ...
            {
               this.var_1605.dispatchEvent(new Event(const_772));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_561 != null)
         {
            this.var_561.remove(param1);
            this.var_561.add(param1,param2);
         }
         if(this.var_563 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_561 != null)
         {
            _loc2_ = this.var_561.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_461,const_673,const_672,const_671,TILE_CURSOR,const_1092];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_471.getValue(param1) as String;
      ...
      {
         var _loc3_:Map = this.var_1074[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_853.getValue(param1) != null)
         {
            return this.var_853.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_214 != null && this.var_214.hasWorldType(const_368 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_286 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_692.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1604.getValue(param1) != null)
         {
            this.var_214 = this.var_1604.getValue(param1) as PublicRoomData;
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1818);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2890.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1074.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1604.add(param1,_loc4_);
         this.var_214 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_854.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_854.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_854.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_536.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_472.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_472.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_472[_loc2_] != null)
         {
            _loc3_ = this.var_472.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_368 + param1) == RoomObjectCategoryEnum.const_78)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_214.getWorldHeightScale(const_368 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_214 != null)
         {
            return this.var_214.getWorldScale(const_368 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_471.add(param1,param2);
      }
   }
}
