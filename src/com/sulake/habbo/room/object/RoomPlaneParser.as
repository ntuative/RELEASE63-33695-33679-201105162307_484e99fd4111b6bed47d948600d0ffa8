package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_1082:Number = 0.25;
      
      private static const const_1122:Number = 0.25;
      ...
      private var var_1367:Number = 1.0;
      
      private var _floorThicknessMultiplier:Number = 1.0;
      
      private var var_921:Number = 0.0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_245 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_467 || param1 == this.var_468)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_469;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_689[_loc2_][_loc8_] = this.var_129[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         ...
         this.var_921 = getFloorHeight(this.var_129);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_396,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1122 * this.var_1367;
         var _loc9_:Number = const_1082 * this._floorThicknessMultiplier;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_284,param1,param2,param3);
         var _loc13_:IVector3d = param1;
         var _loc14_:* = null;
         var _loc15_:* = null;
         if(_loc12_)
         {
            _loc16_ = const_1082 * this._floorThicknessMultiplier;
            if(param8 > 0)
            {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_284,_loc13_,new Vector3d(0,0,-_loc16_),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_284,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_284,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_284,_loc13_,new Vector3d(0,0,-_loc16_),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_245}" height="{this._height}" wallHeight="{this.var_1592}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_689[_loc2_];
            _loc6_ = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1242;
         }
         var _loc2_:RoomPlaneData = this.var_133[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
