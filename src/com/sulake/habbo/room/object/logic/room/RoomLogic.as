package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1321:uint = 16777215;
      
      private var var_2073:int = 255;
      
      private var var_1320:int = 0;
      
      private var var_2074:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_590,RoomObjectMouseEvent.const_140];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1312,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_764,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_765,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_790,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_855,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1320)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1919;
            if(_loc2_ - this.var_1320 >= this.var_2074)
            {
               _loc3_ = this.var_1321;
               _loc4_ = this.var_2073;
               this.var_1320 = 0;
            }
            else
            {
               _loc7_ = this.var_1602 >> 16 & 255;
               _loc8_ = this.var_1602 >> 8 & 255;
               _loc9_ = this.var_1602 & 255;
               _loc10_ = this.var_1321 >> 16 & 255;
               _loc11_ = this.var_1321 >> 8 & 255;
               _loc12_ = this.var_1321 & 255;
               _loc13_ = (_loc2_ - this.var_1320) / this.var_2074;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2072 + (this.var_2073 - this.var_2072) * _loc13_;
               this._color = _loc3_;
               this.var_1919 = _loc4_;
            }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_682:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_775:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_575:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_954:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1124,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1107:
               param2.setNumber(RoomObjectVariableEnum.const_765,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1280:
               param2.setNumber(RoomObjectVariableEnum.const_790,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_855,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1082:
               param2.setNumber(RoomObjectVariableEnum.const_1193,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1122:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1602 = this._color;
         this.var_2072 = this.var_1919;
         this.var_1321 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_609,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc13_ && _loc7_.y >= 0 && _loc7_.y < _loc14_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1655,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1680,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_609,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_257 || _loc12_ == RoomPlaneData.const_396)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
