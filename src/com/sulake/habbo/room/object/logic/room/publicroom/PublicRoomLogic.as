package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_196,RoomObjectRoomAdEvent.const_310,RoomObjectRoomAdEvent.const_337];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setNumber(RoomObjectVariableEnum.const_555,Number(false));
         this.var_847 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1545 > 0 && param1 > this.var_1545)
         {
            this.adDelayTimeout();
            this.var_1545 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1278:
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_555,Number(true));
                  this.var_1545 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1158);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_555,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_551)
               {
