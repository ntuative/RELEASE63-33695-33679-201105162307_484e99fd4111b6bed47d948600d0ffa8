package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1942:int = 1;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1748.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1748).length == 0)
            {
               if(object.getState(0) != const_1019)
               {
                  object.setState(const_1019,0);
               }
            }
         }
      }
