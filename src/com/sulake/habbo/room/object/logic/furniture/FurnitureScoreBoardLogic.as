package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         {
            _loc3_ = this.var_842 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_460 > const_1079)
            {
               this.var_954 = const_1079 / _loc3_;
            }
            else
            {
               this.var_954 = const_460;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_842 && param1 >= this.var_1584 + this.var_954)
            {
               ...
               if(_loc4_ > _loc5_ * (this.var_842 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_842 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1584 = param1 - (_loc3_ - _loc4_ * this.var_954);
            }
         }
      }
   }
