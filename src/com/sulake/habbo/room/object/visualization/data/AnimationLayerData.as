package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_1770;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1769)
         {
            _loc6_ = param2 / this.var_436;
            param2 %= this.var_436;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_436 == 1)
            {
               param2 = this.var_436 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
