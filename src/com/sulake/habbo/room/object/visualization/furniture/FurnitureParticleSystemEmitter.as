package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1875:String = "cone";
      
      public static const const_1851:String = "plane";
      
      public static const const_1848:String = "sphere";
      ...
      private var var_958:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_957 = 0;
         this.var_892 = false;
         this.init(0,0,0,this._direction,this.var_2515,this.var_958,this.var_2513,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1181.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_892 = true;
         if(this.var_957 < this.var_1459)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2512)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_958,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1181.length);
         return this.var_1181[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_957 < this.var_1459)
         {
            if(this.age % this.var_2516 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_957 < this.var_1459)
         {
            ...
            this.y = (2 - this.var_255) * this.y - (1 - this.var_255) * this.lastY + this.var_1817 * this.var_958 * this.var_958;
         ...
         for each(_loc2_ in this.var_363)
         {
            ...
            _loc2_.y = (2 - this.var_255) * _loc2_.y - (1 - this.var_255) * _loc2_.lastY + this.var_1817 * this.var_958 * this.var_958;
