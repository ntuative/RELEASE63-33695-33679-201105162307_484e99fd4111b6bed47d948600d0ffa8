package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1112:Number = 1.0;
      
      private var var_583:BitmapData;
      
      private var var_712:ColorTransform;
      
      private var var_1371:ColorTransform;
      
      private var var_1656:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1371 = new ColorTransform();
         this.var_1656 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_101 = this.var_1111[param1];
         this.var_892 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1655 >= 0)
         {
            this.var_243 = this._visualization.getSprite(this.var_1655);
            if(this.var_243 && this.var_243.asset)
            {
               ...
               if(this.var_85 == null)
               {
                  this.var_85 = this.var_243.asset.clone();
                  if(this.var_712.alphaMultiplier != 1)
                  {
                     this.var_583 = new BitmapData(this.var_85.width,this.var_85.height,true,4278190080);
                  }
               }
               this.var_2207 = -this.var_243.offsetX;
               this.var_2208 = -this.var_243.offsetY;
               this.var_243.asset = this.var_85;
            }
            if(this.var_85)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_101.y * this.var_1112;
         }
         return 0;
      }
      ...
      {
         if(!this.var_101 || !this.var_243)
         {
            return;
         }
         if(this.var_85 && this.var_243.asset != this.var_85)
         {
            this.var_243.asset = this.var_85;
         }
         if(this.var_892)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_892 && this.var_101.hasIgnited)
         {
            this.var_892 = true;
         }
         _loc8_ = this.var_1232 * this.var_1112;
         this.var_101.update();
         if(this.var_892)
         {
            if(this.var_101.roomObjectSpriteId >= 0)
            ...
            {
               this.var_85.draw(this.var_583,this.var_1656,this.var_712,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_101.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2207 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1112;
               _loc4_ = this.var_2208 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1112;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1371.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_85.draw(_loc7_,this._translationMatrix,this.var_1371,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function method_17(param1:XML) : void
      {
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc5_:* = null;
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2209 = parseInt(param1.@size);
         this.var_1655 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1232 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1112 = this.var_2209 / 64;
         ...
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc19_ = _loc23_.@is_emitter == "HabboRoomUICom_icon_cd_big" ? false : true;
               _loc20_ = _loc23_.hasOwnProperty("@fade") && _loc23_.@fade == "HabboConfigurationCom_default_configuration" ? true : false;
               _loc21_ = [];
