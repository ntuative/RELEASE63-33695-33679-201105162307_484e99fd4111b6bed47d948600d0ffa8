package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1558:String = "shore";
      ...
      {
         if(this.var_2799 == param1 && this.var_2798 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1558)
            {
               this.var_2005 = _loc2_;
               this.var_2799 = param1;
               this.var_2798 = direction;
               return this.var_2005;
            }
            _loc2_--;
         }
      ...
      private function method_11(param1:int) : IGraphicAsset
      {
         var _loc2_:int = getSize(param1);
         var _loc3_:IGraphicAsset = ShoreMaskCreatorUtility.method_11(object.getInstanceId(),_loc2_,assetCollection,this.getShoreAsset(param1));
         if(_loc3_ != null)
         {
            if(this.var_1288.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_2004 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_465.length)
         {
            if(this.var_465[_loc5_] == true)
            {
               this.var_2004 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_552 == 0 || this.var_671 == 0)
         {
            ...
            this.var_552 = _loc2_.getNumber(RoomObjectVariableEnum.const_355);
            this.var_671 = _loc2_.getNumber(RoomObjectVariableEnum.const_398);
         }
         this.var_465 = [];
         this.var_672 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_552 * 2 + this.var_671 * 2)
         {
            this.var_465.push(false);
            this.var_672.push(ShoreMaskCreatorUtility.const_81);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_465,this.var_672,assetCollection);
      }
      ...
      private function updateInstanceShoreMask(param1:Number) : Boolean
      {
         ...
         var _loc2_:IGraphicAsset = this.method_11(param1);
