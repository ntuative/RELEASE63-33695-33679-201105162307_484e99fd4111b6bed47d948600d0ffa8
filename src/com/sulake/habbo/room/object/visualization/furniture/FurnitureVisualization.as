package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1929:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2705:Number = NaN;
      
      private var var_2704:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1252:String = null;
      ...
      private var var_2706:Number = 0.0;
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1535)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2704);
               ...
               _loc4_.clickHandling = this.var_2674;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_420:
               break;
            case LayerData.const_1115:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1243:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_483 != _loc3_.getUpdateID() || param1 != var_92 || param2 != this.var_2705)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2704 = _loc3_.getNumber(RoomObjectVariableEnum.const_251);
            ...
            this.var_1252 = this.getAdClickUrl(_loc3_);
            if(this.var_1252 == null || this.var_1252.indexOf("http") != 0)
            {
               this.var_1252 = null;
            }
            this.var_2674 = this.var_1252 != null;
            this.var_2706 = _loc3_.getNumber(RoomObjectVariableEnum.const_936);
      ...
      {
         if(this.var_2702 != param2 || this.var_2703 != param1)
         {
            this.var_1018 = [];
            this.var_1019 = [];
            this.var_809 = [];
            ...
            this.var_2707 = this.getSize(param1);
      ...
      {
         this.var_668 = param1;
         this.var_1535 = this.var_668 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_611.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1018[param2];
         var _loc4_:Boolean = this.var_1019[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2707;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1535)
            {
               _loc6_ = FurnitureVisualizationData.const_611[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1018[param2] = _loc3_;
            this.var_1019[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_807[param3] != null && !this.var_1935)
         {
      ...
      {
         if(this.var_806[param2] != null)
         {
            return this.var_806[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2706 * (param1 / 2));
      }
