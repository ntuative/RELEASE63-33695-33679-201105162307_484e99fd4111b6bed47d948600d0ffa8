package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      {
         return param1 + param2 * const_1393;
      }
      
      public static function method_11(param1:int, param2:int, param3:IGraphicAssetCollection, param4:IGraphicAsset) : IGraphicAsset
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_166,const_81,const_69,const_166,const_81,const_69];
                     _loc8_ = [const_81,const_81,const_81,const_69,const_69,const_69];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
