package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1007:IPlaneRasterizer = null;
      ...
      private var var_2658:Number = 0;
      
      private var var_200:Map = null;
      
      private var var_451:PlaneBitmapData = null;
      ...
      private var var_233:BitmapData = null;
      ...
      private var var_802:Boolean = true;
      ...
      {
         return this._isVisible && this.var_802;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_662);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1007.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_451;
         if(_loc3_ == null)
         {
         ...
         if(this.var_802 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_383))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1007 != null)
            {
               _loc3_ = this.var_1007.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1922,this.var_2656,this.var_2659,this.var_2657,this.var_2658,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1651 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_802)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1518.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1518[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1173);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_166.z - originZ,this.var_118.z - originZ,this.var_88.z - originZ,this.var_119.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2501 = relativeDepth;
            this._isVisible = true;
            this.var_1651 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2660);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1005)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_384.length)
            {
               _loc5_ = this.var_384[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_265.length == this.var_1006.length)
         {
            while(_loc1_ < this.var_265.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1006[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_384.length > this.var_1519.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1005 || this.var_265.length == 0 && this.var_384.length == 0 && !this.var_383 || this.var_748 == null)
         {
            return;
         }
         ...
         if(this.var_383)
         {
            ...
            while(_loc5_ < this.var_265.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_304.length;
                  _loc12_ = _loc3_.type;
                  this.var_748.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1006.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_384.length)
            {
               _loc4_ = this.var_384[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_303.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_304.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_303.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_304.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1519.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_383 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_233 != null && (this.var_233.width != param1.width || this.var_233.height != param1.height))
         {
            this.var_233.dispose();
            this.var_233 = null;
         }
         if(this.var_233 == null)
         {
            this.var_233 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_233.copyChannel(param1,param1.rect,const_662,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_233.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_233,this.var_233.rect,const_662,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
