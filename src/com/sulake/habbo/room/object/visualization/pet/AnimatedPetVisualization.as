package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1492:String = "head";
      
      private static const const_660:int = 1;
      
      private static const const_1050:int = 1000;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_153)
         {
            ...
            this.var_1790 = _loc3_.getNumber(RoomObjectVariableEnum.const_435) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_222);
            if(!isNaN(_loc8_))
            {
               this.var_1910 = _loc8_;
            }
            else
            {
               this.var_1910 = direction;
            }
            this.var_1512 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2303 = _loc3_.getNumber(RoomObjectVariableEnum.const_714);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_927);
            if(_loc9_ != this.var_1909)
            {
               this.var_1909 = _loc9_;
               this.var_2638 = this.var_1909.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_381 != null)
         {
            ...
            if(this.var_1512 > 0)
            {
               ...
               if(_loc2_ < const_1050)
               {
                  this.var_381.alpha = int(Math.sin(_loc2_ / const_1050 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param2 != this.var_1445)
         {
            ...
            this.setAnimationForIndex(const_1493,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2638);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_660)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_611.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_611[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1910);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_92,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1492)
            {
               this.var_1003[param1] = true;
            }
            else
            {
               this.var_1003[param1] = false;
            }
         }
         return this.var_1003[param1];
      }
   }
}
