package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      {
         return this._questEngine.configuration.getKey("standaloneAchievementList.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration";
      }
   }
}
