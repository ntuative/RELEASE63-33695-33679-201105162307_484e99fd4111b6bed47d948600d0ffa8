package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1379:int = 5;
      ...
      private var var_1137:QuestController;
      
      private var var_922:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1137 = new QuestController(this);
         this.var_922 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1379);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_397.events.removeEventListener(BadgeImageReadyEvent.const_111,this.var_922.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_111,this.var_922.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1137.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_922.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1137.questTracker.isVisible();
      }
      ...
      {
         return this.var_191.getKey("questing.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration";
      }
