package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1354:int = 56;
      
      private static const const_638:int = 5;
      
      private static const const_1353:int = 5;
      
      private static const const_1352:int = 30;
      
      private static const const_998:Point = new Point(8,8);
      
      private static const const_1355:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_306 == null || this.var_306.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + const_1353;
         var _loc4_:int = _loc2_.height - _loc3_ + (!!_loc2_.visible ? 0 : const_1352);
         _loc2_.visible = true;
         var _loc5_:IRegionWindow = IRegionWindow(this._window.findChildByName("catalog_link_region"));
         var _loc6_:* = const_1355.indexOf(param1.type) > -1;
         _loc5_.y = _loc2_.y + _loc2_.height + const_638;
         var _loc7_:int = 0;
         if(_loc6_ && !_loc5_.visible)
         {
            _loc7_ = const_638 + _loc5_.height;
         }
         if(!_loc6_ && _loc5_.visible)
         {
            _loc7_ = -const_638 - _loc5_.height;
         ...
         this._window.height = _loc9_.height + const_1354;
