package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1487:String = "HELP";
      
      private static const const_1488:String = "ROOMINFO";
      ...
      private const const_909:int = 41;
      ...
      {
         this.var_58.removeListItem(this.var_370);
      }
      
      public function showRoomInfo() : void
      {
         this.var_58.addListItemAt(this.var_370,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_970;
         _loc3_.y = this.const_909;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_649)
         {
            this.var_649 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1487);
               break;
