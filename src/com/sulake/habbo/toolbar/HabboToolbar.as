package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_986:ToolbarExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_267.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_267 && this._windowManager && this._config)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration")
         {
            this.var_986 = new ToolbarExtension(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
      ...
      public function setToolbarState(param1:String) : void
      {
         switch(param1)
         {
            case HabboToolbarEnum.const_750:
               this.var_986.hideRoomInfo();
               break;
            case HabboToolbarEnum.const_793:
               this.var_986.showRoomInfo();
         }
         if(this._view)
         {
