package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1349:Point = new Point(3,3);
      
      private static const const_1347:uint = 7433577;
      
      private static const const_1348:uint = 5723213;
      
      private static const const_446:String = "_hover";
      
      private static const const_445:String = "_normal";
      ...
      private var var_1364:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1349;
         ...
         {
            this.setIconHoverState(_loc11_,const_445);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_750:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_793:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_446);
               this.setIconBgHoverState(_loc3_,const_446);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_445);
               this.setIconBgHoverState(_loc3_,const_445);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_446 ? this.var_1364 : this.var_1363;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_446)
         {
            param1.color = const_1347;
         }
         else
         {
            param1.color = const_1348;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1363 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1364)
         {
            this.var_1364.dispose();
         }
         this.var_1364 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_881.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_996;
            _loc2_.y = const_996;
            this.var_881.add(param1,_loc2_);
         }
         return _loc2_;
      }
