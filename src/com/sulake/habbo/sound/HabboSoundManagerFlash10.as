package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1560:int = 60;
      
      private static const const_1559:int = 25165823;
      
      private static const const_1561:int = 16777215;
      ...
      private var var_948:Number = 1.0;
      ...
      private var var_1571:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_841,this.onTraxLoadComplete);
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1323:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1667:
      ...
      {
         if(this.var_191 == null || this._connection == null || this._roomEngine == null || this.var_220 != null)
         {
            return;
         }
         this.var_220 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_220.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1666,this.var_835));
         this.var_835 = -1;
         this.var_834 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_948 * 100)));
         }
      }
      ...
      {
         this.var_948 = param1;
         this.var_220.updateVolume(this.var_948);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_674.getValue(param1) != null)
         {
            ...
            if(this.var_279.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1571,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1571,_loc2_,TraxSample.const_1671,TraxSample.const_1760);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1290.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1560 && this.var_1290.length > 0)
            {
               _loc3_ = this.var_1290.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_674.length == 0 && this.var_835 != -1)
            {
               this.var_834.ready = true;
               _loc4_ = this.var_835;
               this.var_835 = -1;
               this.var_834 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_841,_loc4_));
               if(this.var_2801)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_834 == null && this.var_1289.length > 0)
         {
            ...
            if(_loc2_ != null && !_loc2_.disposed)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_841,_loc1_));
               }
               else
               {
                  this.var_834 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_220.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1559)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1561 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_220.samplesUnloaded(_loc7_);
            }
         }
      }
