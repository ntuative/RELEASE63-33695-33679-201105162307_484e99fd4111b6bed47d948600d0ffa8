package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1476:int = HabboMusicPrioritiesEnum.const_131;
      ...
      private var var_524:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_739.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_739.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_739)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_844,this.onJukeboxInit);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_280,this.onJukeboxDispose);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_884,this.onSoundMachineInit);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_820,this.onSoundMachineDispose);
         this.var_1210 = new Timer(1000);
         this.var_1210.start();
         this.var_1210.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1868)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_844,this.onJukeboxInit);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_280,this.onJukeboxDispose);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_884,this.onSoundMachineInit);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_820,this.onSoundMachineDispose);
            }
      ...
      public function method_3(param1:int, param2:int, param3:Number = 0, param4:Number = 0.0, param5:Number = 0.5, param6:Number = 0.5) : Boolean
      {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_643.add(param1,param2);
            this.var_792.push(param1);
         }
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_262.length)
         {
            ...
            if(_loc3_.id != this.var_1486 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_792));
         Logger.log("Requested song info\'s : " + this.var_792);
         this.var_792 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_93,_loc6_.id));
               while(this.var_791.indexOf(_loc6_.id) != -1)
               {
                  this.var_791.splice(this.var_791.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1868 = this.getSongRequestCountAtPriority(param1);
         this.var_1486 = param2;
         if(this._priorityPlaying <= const_1476)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2591 != param1.id || _loc3_ > this.var_2590 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2591 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_524 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_83,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_524 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
