package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_220:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_220 = param2;
         this.var_739 = [];
         this.var_739.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_739.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_739)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_93,this.onSongInfoReceivedEvent);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_864,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_797,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_864,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_797,this.onSoundMachineStopEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_422 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_220.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_422 = -1;
         this.var_593 = false;
         this.var_220.stop(HabboMusicPrioritiesEnum.const_131);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_220.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_220.method_3(param1,HabboMusicPrioritiesEnum.const_131,_loc3_,0,0,0))
         {
