package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1671:String = "sample_44khz";
      
      public static const const_1727:String = "sample_22khz";
      
      public static const const_1912:String = "sample_11khz";
      
      public static const const_1760:String = "sample_16bit";
      
      public static const const_1887:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1015:int = 32;
      
      private static const const_75:int = 255;
      
      private static const const_186:int = 65535;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_160 * this.var_75;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1015)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1015);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_160 == this.var_160 - 1)
            {
               this.var_115[int(_loc11_ / this.var_160)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_115.length * this.var_160 * this.var_75;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_160 * this.var_75;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         if(this.var_75 == 1)
         {
            if(this.var_160 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_186) - const_187;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_186) - const_187;
               }
            }
            else if(this.var_160 == 4)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_115[param4++];
         ...
         else if(this.var_75 >= 2)
         {
            ...
            if(this.var_160 == 2)
            {
               ...
               {
                  _loc8_ = this.var_115[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_186) - const_187);
                  _loc9_ = this.var_75;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_186) - const_187);
                  _loc9_ = this.var_75;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_75 == 1)
         {
            if(this.var_160 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_186) - const_187);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_186) - const_187);
               }
            }
            else if(this.var_160 == 4)
            {
         ...
         else if(this.var_75 >= 2)
         {
            ...
            if(this.var_160 == 2)
            {
               ...
               {
                  _loc7_ = this.var_115[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_186) - const_187);
                  _loc8_ = this.var_75;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_186) - const_187);
                  _loc8_ = this.var_75;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_604.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_604.indexOf(param1) != -1;
      }
   }
}
