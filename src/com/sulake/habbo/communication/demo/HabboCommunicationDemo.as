package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2505:PseudoRandom;
      ...
      private const const_1938:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_627 = param1;
            this.var_55.initConnection(HabboConnectionType.const_259);
         }
      }
      ...
      {
         if(this.var_55 && this.var_139 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_627 = this.var_139.getKey("sso.ticket",null);
         this.var_1811 = this.var_139.getKey("flash.client.url","");
         this.var_2504 = this.var_139.getKey("external.variables.txt","");
         if(this.var_228 == null)
         {
            this.var_228 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_55.mode = HabboConnectionType.const_96;
            if(this.var_627)
            {
               this.var_55.initConnection(HabboConnectionType.const_259);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_489,this.onInitConnection);
            }
            else
            {
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1302;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_694);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2505 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_96:
               ...
               this.var_228.loadBannerImage(_loc7_ + "?token=" + this.var_1450,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1302:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1740:
               this.var_952 = this.generateRandomHexString(30);
               this.var_517 = new DiffieHellman(new BigInteger(this.var_139.getKey("connection.development.prime"),16),new BigInteger(this.var_139.getKey("connection.development.generator"),16));
               this.var_517.init(this.var_952);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2505);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1811,this.var_2504));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1938,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_277);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2503)
         {
