package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_489:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_159.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_149,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1938,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_159.habboConfiguration.getKey("use.sso","HabboRoomUICom_icon_cd_big") == "HabboConfigurationCom_default_configuration")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1938,"/");
         ...
         {
            dispatchEvent(new Event(const_489));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_135.removeEventListener(SSOTicket.const_428,this.onParsedTicketSuccess);
            this.var_135.removeEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
            this.var_135 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_135 = new SSOTicket(this.var_159.assets,_loc3_,_loc2_,param1);
         this.var_135.addEventListener(SSOTicket.const_428,this.onParsedTicketSuccess);
         this.var_135.addEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_159.flashClientUrl = this.var_135.flashClientUrl;
         this.var_159.ssoTicket = this.var_135.ticket;
         this.var_135.removeEventListener(SSOTicket.const_428,this.onParsedTicketSuccess);
         this.var_135.removeEventListener(SSOTicket.const_322,this.onParsedTicketFailure);
         this.var_135 = null;
         dispatchEvent(new Event(const_489));
