package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_2832:WelcomeNotification;
      ...
      public function dispose() : void
      {
         if(this.var_189)
         {
            this.var_189.removeUpdateReceiver(this);
            this.var_189.toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
            this.var_189 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_189.toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_189.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_212.y = this.var_189.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_189.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_189.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_342,false);
         _loc4_.height -= 20;
      ...
      {
         this.var_189.removeUpdateReceiver(this);
         this.var_189.registerUpdateReceiver(this,10);
      }
   }
}
