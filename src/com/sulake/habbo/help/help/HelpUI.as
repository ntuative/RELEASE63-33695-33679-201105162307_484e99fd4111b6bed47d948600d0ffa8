package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1866:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105162302));
         this.var_123 = new Map();
         this.var_123.add(HabboHelpViewEnum.const_1896,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_190,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_587,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_311,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_434,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_766,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_281,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_123.add(HabboHelpViewEnum.const_1319,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_123.add(HabboHelpViewEnum.const_1301,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_987,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_522.length == 0 || param1 != this.var_372)
            {
               this.var_522.push(this.var_372);
            }
         }
         this.var_372 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1225:
               ...
               break;
            case CallForHelpResultEnum.const_1240:
               this.showUI(HabboHelpViewEnum.const_1319);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_123.getValue(HabboHelpViewEnum.const_190) as IHelpViewController;
      ...
      {
         return this.var_123.getValue(this.var_372);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2368 = this._window.width - _loc3_.width;
         this.var_2369 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2369;
         this._window.width = _loc1_.width + this.var_2368;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_522.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_190)
         {
            return;
         }
         if(this.var_640.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_640.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_640[1],this.var_640[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_640[0],this.var_640[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_190 || this.var_522.length == 0)
         {
            return;
         }
         if(this.var_373 == null)
