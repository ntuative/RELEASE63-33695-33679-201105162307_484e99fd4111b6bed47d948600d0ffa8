package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1206:IHabboLocalizationManager;
      
      private var var_983:IHabboConfigurationManager;
      ...
      private var var_788:HotelMergeUI;
      
      private var var_1481:CallForHelpData;
      
      private var var_2580:UserRegistry;
      
      private var var_2579:String = "";
      
      private var var_984:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1481 = new CallForHelpData();
         this.var_2580 = new UserRegistry();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1206)
         {
            this.var_1206.release(new IIDHabboLocalizationManager());
            this.var_1206 = null;
         }
         if(this.var_267)
         {
         ...
         if(this.var_983)
         {
            this.var_983.release(new IIDHabboConfigurationManager());
            this.var_983 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_983.getKey(param1,param2,param3);
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_65.showUI(HabboHelpViewEnum.const_434);
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_65 = new HelpUI(this,this._assetLibrary,this._windowManager);
         }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_788)
         {
            this.var_788 = new HotelMergeUI(this);
         }
         this.var_788.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_108)
         {
            this.var_108.showView(TutorialUI.const_325);
         }
      }
      ...
      {
         this.var_1206 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_983 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_984)
         {
            this.var_984 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_984.showWelcomeScreen(param1);
      }
