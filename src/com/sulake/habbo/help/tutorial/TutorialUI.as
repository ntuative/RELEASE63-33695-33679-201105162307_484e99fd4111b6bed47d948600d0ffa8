package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_412:String = "TUI_CLOTHES_VIEW";
      
      public static const const_527:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_571,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_474,this.onTaskDoneEvent);
      ...
      {
         return this.var_1135 && this.var_1136 && this.var_1409;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_571,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_474,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_630:
               this.var_1409 = true;
               if(this.var_45 != null && this.var_45.id == const_527)
               {
                  this.showView(const_90);
               }
               break;
            case HabboHelpTutorialEvent.const_571:
               if(this.var_45 != null && this.var_45.id == const_412)
               {
                  this.var_1721 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2368 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2369;
         this._window.width = _loc2_.width + this.var_2368;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_325 || this.var_45.id == const_90))
         {
            this.showView(const_90);
         }
      }
      ...
      {
         this.var_1135 = true;
         if(this.var_45 != null && (this.var_45.id == const_412 || this.var_45.id == const_90))
         {
            this.showView(const_90);
         }
      }
