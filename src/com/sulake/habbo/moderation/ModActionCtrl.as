package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1259:IDropMenuWindow;
      ...
      private var var_1023:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1257 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1258 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1946;
         ...
         this.var_1259 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1259);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1023.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1024 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1024.offences,this.var_1257,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1258,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1542,this.var_538.text,this.var_1543));
         this.dispose();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1023 = this.var_1024.offences[_loc3_];
         this.var_538.text = this.var_1023.msg;
         this.var_616 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1542,this.var_538.text,this.var_1543));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1259.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1542,this.var_538.text,this.getBanLength(),this.var_1543));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1259.selection;
