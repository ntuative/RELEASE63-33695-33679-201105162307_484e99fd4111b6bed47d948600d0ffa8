package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1960:IIssueBrowserView;
      
      private var var_1958:IIssueBrowserView;
      
      private var var_1959:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_393.view.width = this.var_272.container.width;
         this.var_393.view.height = this.var_272.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2233:
               ...
               {
                  this.var_1960 = new MyIssuesView(this.issueManager,this,this.var_272.container);
               }
               return this.var_1960;
            case this.const_2235:
               if(this.var_1958 == null)
               {
                  this.var_1958 = new OpenIssuesView(this.issueManager,this,this.var_272.container);
               }
               return this.var_1958;
            case this.const_2234:
               if(this.var_1959 == null)
               {
                  this.var_1959 = new PickedIssuesView(this.issueManager,this,this.var_272.container);
               }
