package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1946;
      ...
      {
         return WindowTracker.const_1845;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.messageTemplates[this.var_1240.selection];
         if(_loc3_ != null)
         {
            this.var_616 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModMessageMessageComposer(this.var_1542,this.var_538.text,this.var_1543));
         this.dispose();
      }
