package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1240:IDropMenuWindow;
      
      private var var_538:ITextFieldWindow;
      
      private var var_616:Boolean = true;
      
      private var var_1008:ICheckBoxWindow;
      
      private var var_1523:ICheckBoxWindow;
      
      private var var_1522:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_400));
         Logger.log("BEGINNING TO SHOW: " + this.var_400);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1886;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_538 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_538.procedure = this.onInputClick;
         this.var_1240 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1240);
         this.var_1240.procedure = this.onSelectTemplate;
         this.var_1008 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1523 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1522 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_811,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_616 || this.var_538.text == "")
         {
         ...
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1683,_loc2_,this.var_538.text,"",""));
         if(this.var_1523.isSelected || this.var_1522.isSelected || this.var_1008.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1523.isSelected,this.var_1522.isSelected,this.var_1008.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1783);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1240.selection];
         if(_loc3_ != null)
         {
            this.var_616 = false;
            this.var_538.text = _loc3_;
         }
      }
   }
}
