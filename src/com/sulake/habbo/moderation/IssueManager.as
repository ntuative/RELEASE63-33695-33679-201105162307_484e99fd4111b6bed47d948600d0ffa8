package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1317:String = "issue_bundle_open";
      
      public static const const_814:String = "issue_bundle_my";
      
      public static const const_1173:String = "issue_bundle_picked";
      
      public static const const_1814:int = 15000;
       
      
      private var var_64:ModerationManager;
      
      private var var_601:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_601 = new IssueBrowser(this,this.var_64.windowManager,this.var_64.assets);
         this.var_1133 = [];
         this.var_1134 = [];
         this.var_920 = new Map();
         this.var_2363 = parseInt(this.var_64.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1719 = new Timer(const_1814,0);
         this.var_1719.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1719.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1133 = this.var_1133.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_175 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_601 == null || !this.var_601.isOpen())
         {
            this.var_64.soundManager.playSound(HabboSoundTypesEnum.const_1323);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1916)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(param1.state == IssueMessageData.const_175)
         {
            ...
            _loc9_ = this.var_1134.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2363);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_920.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_920.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_107)
         {
            ...
            {
               case const_1317:
                  if(_loc4_.state == IssueMessageData.const_175)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_920.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_920.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_410 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_920.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
