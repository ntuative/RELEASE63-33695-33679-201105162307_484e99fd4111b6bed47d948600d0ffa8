package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_510 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1158 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         ...
         {
            this.var_1158.load(_loc4_,this.var_164.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_164 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_164.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_164.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_164.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_164.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_164.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1223,_loc2_),this._window,false,false,true);
      }
