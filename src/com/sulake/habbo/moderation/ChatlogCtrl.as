package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2067:int = 1000;
      
      private static var var_1069:Array = [];
      
      private static var var_2066:int = 200;
      ...
      private var var_1994:IMessageComposer;
      ...
      {
         this.var_851 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_852 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1994);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_852.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1070.length < var_2067)
         {
            ...
            param1.width = this.var_852.width;
            param1.height = this.var_852.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2068[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1600.getValue(param2.chatterName))
            {
               this.var_1600.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1600.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1601)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1599)
         {
